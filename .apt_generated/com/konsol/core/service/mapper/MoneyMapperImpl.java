...
public class MoneyMapperImpl implements MoneyMapper {
    ...
    protected MoneyKind kindEnumToMoneyKind(MoneyDTO.KindEnum kindEnum) {
        ...
        switch (kindEnum) {
            case PAYMENT:
                moneyKind = MoneyKind.PAYMENT;
                break;
            case RECEIPT:
                moneyKind = MoneyKind.RECEIPT;
                break;
            default:
    ...
    protected MoneyDTO.KindEnum moneyKindToKindEnum(MoneyKind moneyKind) {
        ...
        switch (moneyKind) {
            case PAYMENT:
                kindEnum = MoneyDTO.KindEnum.PAYMENT;
                break;
            case RECEIPT:
                kindEnum = MoneyDTO.KindEnum.RECEIPT;
                break;
            default:
                throw new IllegalArgumentException("Unexpected enum constant: " + moneyKind);
        }
