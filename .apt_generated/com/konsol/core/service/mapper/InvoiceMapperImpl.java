...
public class InvoiceMapperImpl implements InvoiceMapper {
    ...
    protected InvoiceKind kindEnumToInvoiceKind(InvoiceDTO.KindEnum kindEnum) {
        ...
        switch (kindEnum) {
            case SALE:
                ...
                break;
            case PURCHASE:
                invoiceKind = InvoiceKind.PURCHASE;
                break;
            case ADJUST:
                invoiceKind = InvoiceKind.ADJUST;
                break;
            case TRANSFER:
                invoiceKind = InvoiceKind.TRANSFER;
                break;
            case SALEQUOTE:
                invoiceKind = InvoiceKind.SALEQUOTE;
                break;
            case RETURNPUR:
                invoiceKind = InvoiceKind.RETURNPUR;
                break;
            case RETURNSALE:
                invoiceKind = InvoiceKind.RETURNSALE;
                break;
            case COMPONENT:
                invoiceKind = InvoiceKind.COMPONENT;
                break;
            default:
                throw new IllegalArgumentException("Unexpected enum constant: " + kindEnum);
        }
    ...
    protected AccountKind kindEnumToAccountKind(AccountUserDTO.KindEnum kindEnum) {
        ...
        switch (kindEnum) {
            case CUSTOMER:
                ...
                break;
            case SUPPLIER:
                accountKind = AccountKind.SUPPLIER;
                break;
            case SALEMAN:
                accountKind = AccountKind.SALEMAN;
                break;
            default:
                throw new IllegalArgumentException("Unexpected enum constant: " + kindEnum);
        }
    ...
    protected InvoiceDTO.KindEnum invoiceKindToKindEnum(InvoiceKind invoiceKind) {
        ...
        switch (invoiceKind) {
            case SALE:
                kindEnum = InvoiceDTO.KindEnum.SALE;
                break;
            case PURCHASE:
                kindEnum = InvoiceDTO.KindEnum.PURCHASE;
                break;
            case ADJUST:
                kindEnum = InvoiceDTO.KindEnum.ADJUST;
                break;
            case TRANSFER:
                kindEnum = InvoiceDTO.KindEnum.TRANSFER;
                break;
            case SALEQUOTE:
                kindEnum = InvoiceDTO.KindEnum.SALEQUOTE;
                break;
            case RETURNPUR:
                kindEnum = InvoiceDTO.KindEnum.RETURNPUR;
                break;
            case RETURNSALE:
                kindEnum = InvoiceDTO.KindEnum.RETURNSALE;
                break;
            case COMPONENT:
                kindEnum = InvoiceDTO.KindEnum.COMPONENT;
                break;
            default:
                throw new IllegalArgumentException("Unexpected enum constant: " + invoiceKind);
        }
    ...
    protected AccountUserDTO.KindEnum accountKindToKindEnum(AccountKind accountKind) {
        ...
        switch (accountKind) {
            case CUSTOMER:
                kindEnum = AccountUserDTO.KindEnum.CUSTOMER;
                break;
            case SUPPLIER:
                kindEnum = AccountUserDTO.KindEnum.SUPPLIER;
                break;
            case SALEMAN:
                kindEnum = AccountUserDTO.KindEnum.SALEMAN;
                break;
            default:
                throw new IllegalArgumentException("Unexpected enum constant: " + accountKind);
        }
    ...
    protected InvoiceViewSimpleDTO.KindEnum invoiceKindToKindEnum1(InvoiceKind invoiceKind) {
        ...
        switch (invoiceKind) {
            case SALE:
                kindEnum = InvoiceViewSimpleDTO.KindEnum.SALE;
                break;
            case PURCHASE:
                kindEnum = InvoiceViewSimpleDTO.KindEnum.PURCHASE;
                break;
            case ADJUST:
                kindEnum = InvoiceViewSimpleDTO.KindEnum.ADJUST;
                break;
            case TRANSFER:
                kindEnum = InvoiceViewSimpleDTO.KindEnum.TRANSFER;
                break;
            case SALEQUOTE:
                kindEnum = InvoiceViewSimpleDTO.KindEnum.SALEQUOTE;
                break;
            case RETURNPUR:
                kindEnum = InvoiceViewSimpleDTO.KindEnum.RETURNPUR;
                break;
            case RETURNSALE:
                kindEnum = InvoiceViewSimpleDTO.KindEnum.RETURNSALE;
                break;
            case COMPONENT:
                kindEnum = InvoiceViewSimpleDTO.KindEnum.COMPONENT;
                break;
            default:
                throw new IllegalArgumentException("Unexpected enum constant: " + invoiceKind);
        }
