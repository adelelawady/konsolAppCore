...
(function (factory) {
  ...
  class MaskedDynamic extends Masked {
    ...
    get isComplete() {
      ...
      return Boolean(
        (_this$currentMask2 = this.currentMask) === null || _this$currentMask2 === void 0 ? void 0 : _this$currentMask2.isComplete
      );
    }
    get isFilled() {
      var _this$currentMask3;
      return Boolean(
        (_this$currentMask3 = this.currentMask) === null || _this$currentMask3 === void 0 ? void 0 : _this$currentMask3.isFilled
      );
    }
    remove() {
      const details = new ChangeDetails();
    ...
    typedValueEquals(value) {
      ...
      return Boolean(
        (_this$currentMask5 = this.currentMask) === null || _this$currentMask5 === void 0
          ? void 0
