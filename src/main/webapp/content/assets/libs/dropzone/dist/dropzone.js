...
var $b657c03155fc27e2$var$defaultOptions = {
   ...
   */ fallback: function () {
    ...
    try {
      for (
        var _iterator = this.element.getElementsByTagName('div')[Symbol.iterator](), _step;
        !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
        _iteratorNormalCompletion = true
      ) {
  ...
  addedfile: function (file) {
    ...
    if (this.previewsContainer && !this.options.disablePreviews) {
      ...
      try {
        for (
          var _iterator = file.previewElement.querySelectorAll('[data-dz-name]')[Symbol.iterator](), _step;
          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
          _iteratorNormalCompletion = true
        ) {
      ...
      try {
        for (
          var _iterator1 = file.previewElement.querySelectorAll('[data-dz-size]')[Symbol.iterator](), _step1;
      ...
      if (this.options.addRemoveLinks) {
        file._removeLink = $a601ff30f483e917$export$2e2bcd8739ae039.createElement(
      ...
      var removeFileEvent = function (e) {
        ...
        if (file.status === $a601ff30f483e917$export$2e2bcd8739ae039.UPLOADING)
          return $a601ff30f483e917$export$2e2bcd8739ae039.confirm(_this.options.dictCancelUploadConfirmation, function () {
            return _this1.removeFile(file);
          });
        else {
          var _this2 = _this;
          if (_this.options.dictRemoveFileConfirmation)
            return $a601ff30f483e917$export$2e2bcd8739ae039.confirm(_this.options.dictRemoveFileConfirmation, function () {
      ...
      try {
        for (
          var _iterator2 = file.previewElement.querySelectorAll('[data-dz-remove]')[Symbol.iterator](), _step2;
  ...
  thumbnail: function (file, dataUrl) {
    if (file.previewElement) {
      ...
      try {
        for (
          var _iterator = file.previewElement.querySelectorAll('[data-dz-thumbnail]')[Symbol.iterator](), _step;
          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
          _iteratorNormalCompletion = true
        ) {
  ...
  error: function (file, message) {
    if (file.previewElement) {
      ...
      try {
        for (
          var _iterator = file.previewElement.querySelectorAll('[data-dz-errormessage]')[Symbol.iterator](), _step;
          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
          _iteratorNormalCompletion = true
        ) {
          var node = _step.value;
  ...
  uploadprogress: function (file, progress, bytesSent) {
    ...
    if (file.previewElement)
      try {
        for (
          var _iterator = file.previewElement.querySelectorAll('[data-dz-uploadprogress]')[Symbol.iterator](), _step;
          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
          _iteratorNormalCompletion = true
        ) {
          var node = _step.value;
...
var $a601ff30f483e917$export$2e2bcd8739ae039 = /*#__PURE__*/ (function (Emitter) {
  ...
  function $a601ff30f483e917$export$2e2bcd8739ae039(el, options) {
    ...
    _this = $6mU8w$swchelpers.possibleConstructorReturn(
      this,
      $6mU8w$swchelpers.getPrototypeOf($a601ff30f483e917$export$2e2bcd8739ae039).call(this)
    );
    var fallback, left;
    _this.element = el;
    ...
    if (_this.options.forceFallback || !$a601ff30f483e917$export$2e2bcd8739ae039.isBrowserSupported())
      return $6mU8w$swchelpers.possibleConstructorReturn(
        _this,
        _this.options.fallback.call($6mU8w$swchelpers.assertThisInitialized(_this))
      );
    ...
    if (_this.options.previewsContainer !== false) {
      if (_this.options.previewsContainer)
        _this.previewsContainer = $a601ff30f483e917$export$2e2bcd8739ae039.getElement(_this.options.previewsContainer, 'previewsContainer');
      else _this.previewsContainer = _this.element;
    }
    if (_this.options.clickable) {
      if (_this.options.clickable === true) _this.clickableElements = [_this.element];
    ...
    [
        ...
        value: function init() {
          ...
          if (this.clickableElements.length) {
            ...
            var setupHiddenFileInput = function () {
              ...
              $a601ff30f483e917$export$2e2bcd8739ae039
                .getElement(_this.options.hiddenInputContainer, 'hiddenInputContainer')
              ...
              events: {
                click: function (evt) {
                  ...
                  if (
                    ...
                    $a601ff30f483e917$export$2e2bcd8739ae039.elementInside(evt.target, _this11.element.querySelector('.dz-message'))
                  )
      ...
      },
      {
        ...
        value: function paste(e) {
          if (
            $a601ff30f483e917$var$__guard__(e != null ? e.clipboardData : undefined, function (x) {
              return x.items;
            }) == null
          )
            return;
      ...
      },
      {
        ...
        value: function accept(file, done) {
          ...
          else if (!$a601ff30f483e917$export$2e2bcd8739ae039.isValidFile(file, this.options.acceptedFiles))
          ...
          this._transformFiles(files, function (transformedFiles) {
            if (_this.options.chunking) {
              ...
              files[0].upload.chunked =
                _this.options.chunking && (_this.options.forceChunking || transformedFile.size > _this.options.chunkSize);
      ...
      },
      {
        ...
        value: function _addFormElementData(formData) {
          ...
          if (this.element.tagName === 'FORM')
            try {
              for (
                var _iterator = this.element.querySelectorAll('input, textarea, select, button')[Symbol.iterator](), _step;
                !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                _iteratorNormalCompletion = true
              ) {
...
$a601ff30f483e917$export$2e2bcd8739ae039.optionsForElement = function (element) {
  ...
  if (element.getAttribute('id'))
    return $a601ff30f483e917$export$2e2bcd8739ae039.options[$a601ff30f483e917$var$camelize(element.getAttribute('id'))];
  ...
  return (function () {
    ...
    try {
      for (
        ...
        if ($a601ff30f483e917$export$2e2bcd8739ae039.optionsForElement(dropzone) !== false)
...
$a601ff30f483e917$export$2e2bcd8739ae039.isBrowserSupported = function () {
  ...
  if (window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector) {
    if (!('classList' in document.createElement('a'))) capableBrowser = false;
      ...
      if ($a601ff30f483e917$export$2e2bcd8739ae039.blacklistedBrowsers !== undefined)
      ...
      try {
        ...
        for (
          var _iterator = $a601ff30f483e917$export$2e2bcd8739ae039.blockedBrowsers[Symbol.iterator](), _step;
          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
          _iteratorNormalCompletion = true
        ) {
...
$a601ff30f483e917$export$2e2bcd8739ae039.getElements = function (els, name) {
  ...
  if (els instanceof Array) {
    ...
    try {
      for (
        var _iterator = document.querySelectorAll(els)[Symbol.iterator](), _step;
        !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
        _iteratorNormalCompletion = true
      ) {
        el = _step.value;
