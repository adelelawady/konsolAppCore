      ...
      r(e, [
        {
          ...
          value: function (e, t) {
            return (
              (this._callbacks = this._callbacks || {}), this._callbacks[e] || (this._callbacks[e] = []), this._callbacks[e].push(t), this
            );
          },
        },
        {
  ...
  var p = {
      ...
      resize: function (e, t, i, n) {
        ...
        if (r.srcWidth > t || r.srcHeight > i)
          if ('crop' === n)
            a > o ? ((r.srcHeight = e.height), (r.srcWidth = r.srcHeight * o)) : ((r.srcWidth = e.width), (r.srcHeight = r.srcWidth / o));
          else {
      ...
      thumbnail: function (e, t) {
        if (e.previewElement) {
          ...
          try {
            for (
              var a, o = e.previewElement.querySelectorAll('[data-dz-thumbnail]')[Symbol.iterator]();
              !(i = (a = o.next()).done);
              i = !0
            ) {
              var l = a.value;
      ...
      error: function (e, t) {
        if (e.previewElement) {
          ...
          try {
            for (
              var a, o = e.previewElement.querySelectorAll('[data-dz-errormessage]')[Symbol.iterator]();
              !(i = (a = o.next()).done);
              i = !0
            ) {
      ...
      uploadprogress: function (e, t, i) {
        ...
        if (e.previewElement)
          try {
            for (
              var o, l = e.previewElement.querySelectorAll('[data-dz-uploadprogress]')[Symbol.iterator]();
              !(n = (o = l.next()).done);
              n = !0
            ) {
              var s = o.value;
    ...
    f = (function (n) {
      ...
      function o(n, r) {
        ...
        if ((null == l.options.url && (l.options.url = l.element.getAttribute('action')), !l.options.url))
        ...
        return (
          ...
          !1 !== l.options.previewsContainer &&
            (l.options.previewsContainer
              ? (l.previewsContainer = o.getElement(l.options.previewsContainer, 'previewsContainer'))
          ...
          [
                  ...
                  (this.listeners = [
                    {
                      ...
                      events: {
                        ...
                        dragover: function (e) {
                          ...
                          return (
                            (e.dataTransfer.dropEffect = 'move' === t || 'linkMove' === t ? 'move' : 'copy'), k(e), l.emit('dragover', e)
                          );
                        },
                        dragleave: function (e) {
                      ...
                      events: {
                        click: function (i) {
                          return (
                            (e !== t.element ||
                              i.target === t.element ||
                              o.elementInside(i.target, t.element.querySelector('.dz-message'))) &&
                            ...
                            u.isFile
                              ? u.file(function (e) {
                                  if (!c.options.ignoreHiddenFiles || '.' !== e.name.substring(0, 1))
                                    return (e.fullPath = ''.concat(t, '/').concat(e.name)), c.addFile(e);
                                })
              ...
              value: function (e) {
                ...
                (e.upload = { uuid: o.uuidv4(), progress: 0, total: e.size, bytesSent: 0, filename: this._renameFile(e) }),
                  ...
                  this.accept(e, function (i) {
                    i ? ((e.accepted = !1), t._errorProcessing([e], i)) : ((e.accepted = !0), t.options.autoQueue && t.enqueueFile(e)),
                    ...
                    return (
                      ...
                      u(function (r) {
                        ...
                        var l = o.options.resize.call(o, e, t, i, n),
                          ...
                          c = u.getContext('2d');
                        switch (
                          ((u.width = l.trgWidth), (u.height = l.trgHeight), r > 4 && ((u.width = l.trgHeight), (u.height = l.trgWidth)), r)
                        ) {
                          case 2:
              ...
              value: function (e) {
                if (e.status === o.UPLOADING) {
                  ...
                  (e.status !== o.ADDED && e.status !== o.QUEUED) ||
                    ((e.status = o.CANCELED), this.emit('canceled', e), this.options.uploadMultiple && this.emit('canceledmultiple', [e]));
                  ...
                  if (e[0].upload.chunked) {
                    ...
                    var s = function () {
                      ...
                      if (!(t >= l.upload.totalChunkCount)) {
                        ...
                        (l.upload.chunks[t] = { file: l, index: t, dataBlock: s, status: o.UPLOADING, progress: 0, retries: 0 }),
                          r._uploadData(e, [s]);
                      }
                    };
                    if (
            ...
            },
            {
              ...
              value: function (t, i) {
                ...
                var m = this.options.defaultHeaders
                  ? { Accept: 'application/json', 'Cache-Control': 'no-cache', 'X-Requested-With': 'XMLHttpRequest' }
                  : {};
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if ('FORM' === this.element.tagName)
                  try {
                    for (
                      var r = this.element.querySelectorAll('input, textarea, select, button')[Symbol.iterator]();
                      !(t = (s = r.next()).done);
                      t = !0
                    ) {
                      var a = s.value,
            ...
            },
            {
              ...
              value: function (e, t, i) {
                ...
                if (e[0].upload.chunked) {
                  ...
                  i
                    ? ((o.progress = (100 * i.loaded) / i.total), (o.total = i.total), (o.bytesSent = i.loaded))
                  ...
                  try {
                    for (var s, u = e[Symbol.iterator](); !(n = (s = u.next()).done); n = !0) {
                      ...
                      ((c = s.value).upload.total && c.upload.bytesSent && c.upload.bytesSent == c.upload.total) ||
                        (i
                          ? ((c.upload.progress = (100 * i.loaded) / i.total), (c.upload.total = i.total), (c.upload.bytesSent = i.loaded))
            ...
            },
            {
              ...
              value: function (e, t, i) {
                ...
                if (
                  (this.options.uploadMultiple && (this.emit('successmultiple', e, t, i), this.emit('completemultiple', e)),
            ...
            },
            {
              ...
              value: function (e, t, i) {
                ...
                if (
                  (this.options.uploadMultiple && (this.emit('errormultiple', e, t, i), this.emit('completemultiple', e)),
                  this.options.autoProcessQueue)
                )
                  return this.processQueue();
              },
