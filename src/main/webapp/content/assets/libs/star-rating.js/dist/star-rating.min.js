              ...
              if (this.indexActive !== e || t) {
                if (
                  ...
                  'function' == typeof this.props.stars ||
                    this.props.prebuilt ||
                    (this.widgetEl.classList.remove('s' + 10 * (this.indexActive + 1)), this.widgetEl.classList.add('s' + 10 * (e + 1))),
                  this.props.tooltip)
                ) {
                  var s,
          ...
          },
          {
            ...
            value: function () {
              ...
              e.classList.contains(this.props.classNames.base) &&
                (this.props.prebuilt
                  ? ((this.widgetEl = e.querySelector('.' + this.props.classNames.base + '--stars')),
            ...
            value: function (e) {
              ...
              t && 'FORM' === t.tagName && this.eventListener(t, e, ['reset']),
                ...
                ('add' === e && this.el.disabled) ||
                  ...
                  this.eventListener(this.widgetEl, e, ['mousedown', 'mouseleave', 'mousemove', 'touchend', 'touchmove'], !1));
            },
          },
          {
            key: 'indexFromEvent',
      ...
      i(t, [
        {
          ...
          value: function () {
            ...
            this.queryElements(this.selector).forEach(function (t) {
              ...
              'SELECT' !== t.tagName ||
                t.widget ||
                (!i.prebuilt && t.parentNode.classList.contains(i.classNames.base) && e.unwrap(t), e.widgets.push(new u(t, i)));
            });
          },
        },
        {
