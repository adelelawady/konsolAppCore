  ...
  _createClass(Widget, [
        ...
        if (this.indexActive !== index || force) {
          ...
          if (this.props.tooltip) {
            ...
            var label =
              index < 0
                ? this.props.tooltip
                : (_this$values$index = this.values[index]) === null || _this$values$index === void 0
                ? void 0
    ...
    },
    {
      ...
      value: function indexFromEvent(ev) {
        ...
        var origin =
          ((_ev$touches = ev.touches) === null || _ev$touches === void 0 ? void 0 : _ev$touches[0]) ||
          ((_ev$changedTouches = ev.changedTouches) === null || _ev$changedTouches === void 0 ? void 0 : _ev$changedTouches[0]) ||
          ev;
    ...
    },
    {
      ...
      value: function onReset() {
        ...
        var index = this.valueIndex(
          (_this$el$querySelecto = this.el.querySelector('[selected]')) === null || _this$el$querySelecto === void 0
            ? void 0
    ...
    },
    {
      ...
      value: function selectValue(index, triggerChangeEvent) {
        ...
        // (int, bool):void
        this.el.value =
          ((_this$values$index2 = this.values[index]) === null || _this$values$index2 === void 0 ? void 0 : _this$values$index2.value) ||
