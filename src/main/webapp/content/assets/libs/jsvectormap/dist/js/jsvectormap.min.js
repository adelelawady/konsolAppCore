!(function (t, e) {
  ...
  var d = function (t, e, i) {
    ...
    S = {
      on: function (t, e, i, s) {
        void 0 === s && (s = {});
        var a = 'jvm:' + e + '::' + w++;
        (b[a] = { selector: t, handler: i }), (i._uid = a), t.addEventListener(e, i, s);
      },
    ...
    C = (function (e) {
        ...
        if (o && c) {
          ...
          (i.labelX = u.x + u.width / 2 + p[0]),
            ...
            (i.label = i._map.canvas.createText(
              { text: c, textAnchor: 'middle', alignmentBaseline: 'central', dataCode: a, x: i.labelX, y: i.labelY },
              h,
              l
            )),
      ...
      return (
        (s._createRegion = function (t, e, i) {
          return (t = this._map.canvas.createPath({ d: t, dataCode: e }, i)).addClass('jvm-region jvm-element'), t;
        }),
  ...
  var L = (function (e) {
    function i(t) {
      ...
      return (
        ...
        (i.shape = a.canvas.createLine({ x1: r, y1: o, x2: h, y2: l, dataIndex: s }, n, c)),
  ...
  var O = (function (e) {
    function i(t) {
      ...
      return (
        ...
        (i.shape = h.canvas[i._isImage ? 'createImage' : 'createCircle']({ dataIndex: s, cx: r, cy: o }, a, l)),
      ...
      (s._createLabel = function (t) {
        ...
        (this._labelX = n / i.scale - i.transX),
          ...
          (this.label = i.canvas.createText(
            { text: l, dataIndex: e, x: this._labelX, y: this._labelY, dy: '0.6ex' },
    ...
    Y = (function () {
      function t(t, e, i) {
        void 0 === t && (t = {}),
          ...
          this.config.legend && (this.legend = new A(v({ map: this._map, series: this }, this.config.legend))),
  ...
  var E = {
    mill: function (t, e, i) {
      return { x: this.radius * (e - i) * this.radDeg, y: (-this.radius * Math.log(Math.tan((45 + 0.4 * t) * this.radDeg))) / 0.8 };
    },
    merc: function (t, e, i) {
      return { x: this.radius * (e - i) * this.radDeg, y: -this.radius * Math.log(Math.tan(Math.PI / 4 + (t * Math.PI) / 360)) };
    },
    aea: function (t, e, i) {
      var s = i * this.radDeg,
        a = 29.5 * this.radDeg,
  ...
  var T = {
          ...
          h = function (h) {
            ...
            if (('touchstart' == h.type && (r = 0), 1 == d.length))
              ...
              if (2 == r)
                ...
                (l = { top: f.top + window.scrollY, left: f.left + window.scrollX }),
        ...
        for (var n in ((this.linesGroup = this.linesGroup || this.canvas.createGroup('jvm-lines-group')), t)) {
          ...
          !1 !== s &&
            ...
            (this._lines[_(r.from, r.to)] = new L({
              index: n,
              map: this,
              style: v({ initial: this.params.lineStyle }, { initial: r.style || {} }, !0),
              x1: s.x,
              y1: s.y,
              x2: a.x,
              y2: a.y,
      ...
      _createMarkers: function (t, e) {
        ...
        var s = function () {
          ...
          i._markers[a] && i.removeMarkers([a]), (i._markers[a] = { _uid: r, config: s, element: o });
        };
        for (var a in t) s();
      },
      _createSeries: function () {
        for (var t in ((this.series = { markers: [], regions: [] }), this.params.series))
      ...
      _applyTransform: function () {
        ...
        this._defaultWidth * this.scale <= this._width
          ? ((t = (this._width - this._defaultWidth * this.scale) / (2 * this.scale)),
            (i = (this._width - this._defaultWidth * this.scale) / (2 * this.scale)))
          : ((t = 0), (i = (this._width - this._defaultWidth * this.scale) / this.scale)),
          this._defaultHeight * this.scale <= this._height
            ? ((e = (this._height - this._defaultHeight * this.scale) / (2 * this.scale)),
              (s = (this._height - this._defaultHeight * this.scale) / (2 * this.scale)))
      ...
      _setScale: function (t, e, i, s, a) {
        ...
        t > this.params.zoomMax * this._baseScale
          ? (t = this.params.zoomMax * this._baseScale)
          : t < this.params.zoomMin * this._baseScale && (t = this.params.zoomMin * this._baseScale),
          void 0 !== e &&
            void 0 !== i &&
            ((n = t / this.scale),
            s
              ? ((d = e + (this._defaultWidth * (this._width / (this._defaultWidth * t))) / 2),
                (f = i + (this._defaultHeight * (this._height / (this._defaultHeight * t))) / 2))
            ...
            ? ((o = this.scale),
              ...
              (r = setInterval(function () {
                (g += 1),
                  ...
                  m._applyTransform(),
                  g == v && (clearInterval(r), m._emit(k.onViewportChange, [m.scale, m.transX, m.transY]));
              }, 10)))
            : ((this.transX = d),
              (this.transY = f),
              (this.scale = t),
      ...
      coordsToPoint: function (t, e) {
        ...
        return (
          ...
          { x: a + this.transX * this.scale + r.left * this.scale, y: n + this.transY * this.scale + r.top * this.scale }
        );
      },
      ...
      getMarkerPosition: function (t) {
        ...
        return G.maps[this.params.map].projection
          ...
          : { x: e[0] * this.scale + this.transX * this.scale, y: e[1] * this.scale + this.transY * this.scale };
      },
      _repositionLines: function () {
        ...
        for (var i in this._lines) {
          ...
          !1 !== t && !1 !== e && this._lines[i].setStyle({ x1: t.x, y1: t.y, x2: e.x, y2: e.y });
        }
      },
      ...
      return (
        ...
        (s.updateStyle = function () {
          ...
          v(t, this.style.initial),
            ...
            this.isSelected && (v(t, this.style.selected), this.isHovered && v(t, this.style.selectedHover)),
            this.set(t);
        }),
        i
      );
          ...
          S.on(this._map.container, 'mousemove', function (e) {
            if (t._tooltip.classList.contains('active')) {
              var i,
                ...
                (s = '#jvm-regions-group'),
                Element.prototype.querySelector.call(i, s)).getBoundingClientRect(),
        ...
        (e.getValue = function (t) {
          for (var e, i = '#', s = 0; s < 3; s++)
            i +=
              (1 ===
              (e = Math.round(
                this._fromColor[s] + (this._toColor[s] - this._fromColor[s]) * ((t - this.min) / (this.max - this.min))
              ).toString(16)).length
                ? '0'
                : '') + e;
          return i;
    ...
    G = (function () {
      function t(e) {
        var i = this;
        if ((void 0 === e && (e = {}), (this.params = v(t.defaults, e, !0)), !t.maps[this.params.map]))
      ...
      return (
        (e._init = function () {
          ...
          (this.container = f(t.selector)),
            ...
            t.series &&
              (this.container.appendChild((this.legendHorizontal = m('div', 'jvm-series-container jvm-series-h'))),
        ...
        (e.reset = function () {
          ...
          this.legendHorizontal && (g(this.legendHorizontal), (this.legendHorizontal = null)),
            this.legendVertical && (g(this.legendVertical), (this.legendVertical = null)),
  ...
  (G.maps = {}),
    (G.defaults = {
      ...
      markerStyle: {
        initial: { r: 7, fill: '#374151', fillOpacity: 1, stroke: '#FFF', strokeWidth: 5, strokeOpacity: 0.5 },
        hover: { fill: '#3cc0ff', cursor: 'pointer' },
        selected: { fill: 'blue' },
        selectedHover: {},
      },
      markerLabelStyle: {
        initial: { fontFamily: 'Verdana', fontSize: 12, fontWeight: 500, cursor: 'default', fill: '#374151' },
      ...
      regionLabelStyle: {
        initial: { fontFamily: 'Verdana', fontSize: '12', fontWeight: 'bold', cursor: 'default', fill: '#35373e' },
        hover: { cursor: 'pointer' },
      },
    }),
