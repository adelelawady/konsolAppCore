!(function (e, t) {
  'function' == typeof define && define.amd
    ...
    ? (module.exports = t())
    : ((e.Coloris = t()), 'object' == typeof window && e.Coloris.init());
  ...
  return (
    ...
    (O = {
      ...
      theme: 'default',
      themeMode: 'light',
      rtl: !(H = { r: 0, g: 0, b: 0, h: 0, s: 0, v: 0, a: 1 }),
      wrap: !0,
      margin: 2,
      format: 'hex',
      formatToggle: !1,
    ...
    ((Z = (function () {
      var r = { init: G, set: n, wrap: s, close: o, setInstance: W, setColor: J, removeInstance: q, updatePosition: c };
      function t(e) {
        $(function () {
    ...
    if ('object' == typeof o)
      for (var i in o)
        !(function () {
          switch (i) {
            case 'el':
              P(o.el), !1 !== o.wrap && s(o.el);
              break;
            case 'parent':
              (y = b.querySelector(o.parent)) && (y.appendChild(g), (O.parent = o.parent), y === b.body) && (y = null);
              break;
            case 'themeMode':
              (O.themeMode = o.themeMode),
                'auto' === o.themeMode && h.matchMedia && h.matchMedia('(prefers-color-scheme: dark)').matches && (O.themeMode = 'dark');
            case 'theme':
              o.theme && (O.theme = o.theme), (g.className = 'clr-picker clr-' + O.theme + ' clr-' + O.themeMode), O.inline && c();
              break;
            case 'rtl':
              (O.rtl = !!o.rtl),
              ...
              break;
            case 'margin':
              (o.margin *= 1), (O.margin = (isNaN(o.margin) ? O : o).margin);
              break;
            case 'wrap':
              o.el && o.wrap && s(o.el);
              break;
            ...
            case 'swatches':
              ...
              break;
            case 'swatchesOnly':
              (O.swatchesOnly = !!o.swatchesOnly), g.setAttribute('data-minimal', O.swatchesOnly);
              break;
            case 'alpha':
              (O.alpha = !!o.alpha), g.setAttribute('data-alpha', O.alpha);
              break;
            case 'inline':
              (O.inline = !!o.inline),
                g.setAttribute('data-inline', O.inline),
                O.inline && ((e = o.defaultColor || O.defaultColor), (M = R(e)), c(), u(e));
              break;
            case 'clearButton':
              'object' == typeof o.clearButton &&
                (o.clearButton.label && ((O.clearLabel = o.clearButton.label), (x.innerHTML = O.clearLabel)),
                (o.clearButton = o.clearButton.show)),
                (O.clearButton = !!o.clearButton),
                (x.style.display = O.clearButton ? 'block' : 'none');
              break;
            case 'clearLabel':
              (O.clearLabel = o.clearLabel), (x.innerHTML = O.clearLabel);
              break;
            case 'closeButton':
              (O.closeButton = !!o.closeButton), O.closeButton ? g.insertBefore(A, L) : L.appendChild(A);
              break;
            case 'closeLabel':
              (O.closeLabel = o.closeLabel), (A.innerHTML = O.closeLabel);
              break;
            case 'a11y':
              var e,
                t,
                a = o.a11y,
                r = !1;
              if ('object' == typeof a) for (var n in a) a[n] && O.a11y[n] && ((O.a11y[n] = a[n]), (r = !0));
              r &&
                ((e = f('clr-open-label')),
  ...
  function W(e, t) {
    'string' == typeof e && 'object' == typeof t && ((D[e] = t), (j = !0));
  }
  function q(e) {
    delete D[e], 0 === Object.keys(D).length && ((j = !1), e === I) && l();
  }
  function F(l) {
    if (j) {
      var a,
  ...
  function l() {
    0 < Object.keys(N).length && (n(N), (I = ''), (N = {}));
  }
  function P(e) {
    a(b, 'click', e, function (e) {
      O.inline ||
        ...
        c(),
        u(r),
        (O.focusInput || O.selectInput) && E.focus({ preventScroll: !0 }),
    ...
    g &&
      ...
      O.inline ||
        ...
        e
          ? ((c -= o.x),
            (s -= o.y),
            c + l > e.clientWidth && ((c += i.width - l), (r.left = !0)),
            s + a > e.clientHeight - n && a + O.margin <= i.top - (o.y - t) && ((s -= i.height + a + 2 * O.margin), (r.top = !0)),
            (s += e.scrollTop))
          : (c + l > b.documentElement.clientWidth && ((c += i.width - l), (r.left = !0)),
            s + a - t > b.documentElement.clientHeight && a + O.margin <= i.top && ((s = t + i.y - a - O.margin), (r.top = !0))),
  ...
  function o(e) {
    ...
    B &&
      ...
      O.focusInput && t.focus({ preventScroll: !0 }),
      (B = null));
  }
  function u(e) {
    var e = (function (e) {
      ...
      t = (function (e) {
        var t = e.r / 255,
          ...
          i = 0,
          c = 0;
        n && (r === t && (i = (l - a) / n), r === l && (i = 2 + (a - t) / n), r === a && (i = 4 + (t - l) / n), r) && (c = n / r);
  ...
  function Y(e, t) {
    var l,
      ...
      n,
      o,
      e = { h: +S.value, s: (e / w.width) * 100, v: 100 - (t / w.height) * 100, a: C.value / 100 },
      i =
        ((i = (t = e).s / 100),
        (l = t.v / 100),
        (i *= l),
        ...
        (o = [r, i, i, r, l, l][a]),
        (l = [l, l, r, i, i, r][a]),
        { r: v.round(255 * n), g: v.round(255 * o), b: v.round(255 * l), a: t.a });
    U(e.s, e.v), p(i, e), d();
  }
  function U(e, t) {
    var l = O.a11y.marker;
    (e = +e.toFixed(1)), (t = +t.toFixed(1)), (l = (l = l.replace('{s}', e)).replace('{v}', t)), k.setAttribute('aria-label', l);
  }
  function t(e) {
    var t = { pageX: ((t = e).changedTouches ? t.changedTouches[0] : t).pageX, pageY: (t.changedTouches ? t.changedTouches[0] : t).pageY },
      l = t.pageX - w.x,
      t = t.pageY - w.y;
    y && (t += y.scrollTop), X(l, t), e.preventDefault(), e.stopPropagation();
  }
  function X(e, t) {
  ...
  function p(e, t) {
    ...
    var n,
      o = (function (e) {
        ...
        e.g < 16 && (l = '0' + l);
        e.b < 16 && (a = '0' + a);
        O.alpha && (e.a < 1 || O.forceAlpha) && ((e = (255 * e.a) | 0), (r = e.toString(16)), e < 16) && (r = '0' + r);
        return '#' + t + l + a + r;
      })(H),
      i = o.substring(0, 7);
    switch (
      ...
      case 'hsl':
        E.value =
          ((n = (function (e) {
            ...
            return { h: e.h, s: t || 0, l: v.round(100 * a), a: e.a };
          })(H)),
          !O.alpha || (1 === n.a && !O.forceAlpha)
            ? 'hsl(' + n.h + ', ' + n.s + '%, ' + n.l + '%)'
  ...
  function e() {
    ...
    (g.style.color = 'hsl(' + e + ', 100%, 50%)'), (Q.style.left = (e / 360) * 100 + '%'), Y(t, l);
  }
  function z() {
    var e = C.value / 100;
  ...
  function G() {
    b.getElementById('clr-picker') ||
      ...
      a(g, 'click', '.clr-swatches button', function (e) {
        u(e.target.textContent), d(), O.swatchesOnly && o();
      }),
      ...
      a(b, 'mousedown', function (e) {
        (V = !1), g.classList.remove('clr-keyboard-nav'), o();
      }),
      a(b, 'keydown', function (e) {
        ...
        'Escape' === l
          ? o(!0)
          : ['Tab', 'ArrowUp', 'ArrowDown', 'ArrowLeft', 'ArrowRight'].includes(l) && ((V = !0), g.classList.add('clr-keyboard-nav')),
          'Tab' === l &&
            a.matches('.clr-picker *') &&
            ((t = (l = K()).shift()),
            (l = l.pop()),
            r && a === t ? (l.focus(), e.preventDefault()) : r || a !== l || (t.focus(), e.preventDefault()));
      }),
      a(b, 'click', '.clr-field button', function (e) {
        j && l(), e.target.nextElementSibling.dispatchEvent(new Event('click', { bubbles: !0 }));
      }),
  ...
  function J(e, t) {
    (r = (B = t).value), F(t), (M = R(e)), c(), u(e), d(), r !== e && B.dispatchEvent(new Event('change', { bubbles: !0 }));
  }
