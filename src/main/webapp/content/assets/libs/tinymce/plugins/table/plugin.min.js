...
!(function () {
  ...
  const t = e => t =>
      (e => {
        ...
        return null === e
          ...
          : 'object' === t &&
            ((o = l = e),
            (n = String).prototype.isPrototypeOf(o) || (null === (r = l.constructor) || void 0 === r ? void 0 : r.name) === n.name)
          ? 'string'
          : t;
        var o, l, n, r;
      })(t) === e,
    ...
    rt = e =>
      ((e, t) => {
        ...
        return 'border-box' === t
          ? l
          : ((e, t, o, l) =>
              t - nt(e, 'padding-left', 0) - nt(e, 'padding-right', 0) - nt(e, 'border-left-width', 0) - nt(e, 'border-right-width', 0))(
              e,
              l
            );
      })(e, 'content-box');
  ...
  const jt = (e, t, o, l) => {
    ...
    $t = (e, t, o) =>
      ue(e, t).bind(t =>
        ue(e, o).bind(e => {
          return ((o = Wt),
          (l = [t, e]),
          ((e, t, o) => (o.length > 0 ? ((e, t, o, l) => l(e, t, o[0], o.slice(1)))(e, t, o, jt) : y.none()))(zt, (e, t) => o(t), l)).map(
            o => ({ first: t, last: e, table: o })
          );
          var o, l;
        })
      ),
            ...
            ? ze((r = t))
                .bind(e =>
                  ((e, t) =>
                    ...
                    })(e, t))(e, Gt.firstSelectedSelector)
                )
                .fold(d(r), e => e[0])
            : t;
      var r;
    ...
    oo = e => {
      return ((t = e), '#', _e(t, '#') ? ((e, t) => e.substring(t))(t, '#'.length) : t).toUpperCase();
      var t;
    },
    lo = e => {
    ...
    no = e => {
      return (t = lo(e.red) + lo(e.green) + lo(e.blue)), { value: oo(t) };
      var t;
    },
    ro = /^\s*rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)\s*$/i,
    ao = /^\s*rgba\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d?(?:\.\d+)?)\s*\)\s*$/i,
    so = (e, t, o, l) => ({ red: e, green: t, blue: o, alpha: l }),
    co = (e, t, o, l) => {
    ...
    io = e => {
      if ('transparent' === e) return y.some(so(0, 0, 0, 0));
      const t = ro.exec(e);
      if (null !== t) return y.some(co(t[1], t[2], t[3], '1'));
      const o = ao.exec(e);
    ...
    uo = (e, t, o) => l => {
      const n = (e => {
        ...
        a = () => {
          ...
          r
            ? (l.setActive(!I(a, s)), n.set(e.formatter.formatChanged(t, e => l.setActive(!e), !0)))
    ...
    bo = e =>
      N(e, e => {
        ...
        return po(e) ? { text: t, items: bo(e.menu) } : { text: t, value: e.value };
      }),
    go = (e, t, o, l) =>
      N(t, t => {
        const n = t.text || t.title;
        return po(t)
          ? { type: 'nestedmenuitem', text: n, getSubmenuItems: () => go(e, t.menu, o, l) }
          : { text: n, type: 'togglemenuitem', onAction: () => l(t.value), onSetup: uo(e, o, t.value) };
      }),
    ho = (e, t) => o => {
      e.execCommand('mceTableApplyCellStyle', !1, { [t]: o });
    },
    fo = e => F(e, e => (po(e) ? [{ ...e, menu: fo(e.menu) }] : Me(e.value) ? [e] : [])),
      ...
      const l = N(t, e => {
        return {
          ...
          value:
            '#' +
            ((o = e.value),
            ((t = o), (e => eo.test(e) || to.test(e))(t) ? y.some({ value: oo(t) }) : y.none())
              .orThunk(() => io(o).map(no))
              .getOrThunk(() => {
    ...
    vo = [
      ...
      { name: 'valign', type: 'listbox', label: 'Vertical align', items: Zt },
    ],
    To = e =>
      vo.concat(
        (e => {
    ...
    xo = (e, t) => {
      const o = [
        { name: 'borderstyle', type: 'listbox', label: 'Border style', items: [{ text: 'Select...', value: '' }].concat(bo(bt(e))) },
      ...
      const t = N(
          ...
          e =>
            (e => {
              ...
              return 'tfoot' === e.section ? { type: 'footer' } : t || o ? { type: 'header', subType: Oo(t, o) } : { type: 'body' };
            })(e).type
        ),
        o = D(t, 'header'),
        l = D(t, 'footer');
    ...
    Io = (e, t, o) => {
      const l = (e => {
        ...
        N(t.selection, t => {
          return ((l = t),
          ((e, t, o = h) => (o(t) ? y.none() : D(e, G(t)) ? y.some(t) : me(t, e.join(','), e => z(e, 'table') || o(e))))(
            ['td', 'th'],
            l,
            n
          ))
            ...
            (o[s] = (...o) => {
              ...
              return {
                ...
                match: e => {
                  ...
                  if (!q(t, e => D(l, e)))
                    throw new Error(
                      'Not all branches were specified when using match. Specified: ' + l.join(', ') + '\nRequired: ' + t.join(', ')
                    );
    ...
    zo = (e, t) => {
      ...
      return N(n, e => ({ element: e.element.dom, column: Ze(o, e.column).map(e => e.element.dom) }));
    },
    Wo = (e, t, o, l) => {
      const n = l.getData();
      l.close(),
    ...
    $o = e => {
      ...
      const o = ((e, t) => {
        ...
        l = { type: 'tabpanel', tabs: [{ title: 'General', name: 'general', items: To(e) }, xo(e, 'cell')] },
        n = { type: 'panel', items: [{ type: 'grid', columns: 2, items: To(e) }] };
          ...
          ((e, t, o, l) => {
            ...
            if (T(n) > 0) {
              ...
              r &&
                ...
                ze(V.fromDom(t[0])).each(t => lt(e, t.dom, { structure: o, style: r }));
            }
          })(e, t, o, n),
            e.focus();
        });
    ...
    Jo = e => {
      ...
      const o = N(t, t =>
        ...
        l = qo(o),
        n = { type: 'tabpanel', tabs: [{ title: 'General', name: 'general', items: Go(e) }, xo(e, 'row')] },
        r = { type: 'panel', items: [{ type: 'grid', columns: 2, items: Go(e) }] };
      e.windowManager.open({
    ...
    Xo = (e, t, o, n) => {
      ...
      else if (t.children) for (let l = 0; l < t.children.length; l++) Xo(e, t.children[l], o, n);
    },
    Yo = (e, t, o, l) => {
      const n = e.dom,
        r = l.getData(),
          ...
          if (T(s) > 0) {
            ((e, t, o) => {
              ...
              if (
                ...
                St(e)
                  ? ((r['border-width'] = fe(o.border)), (r['border-spacing'] = fe(o.cellspacing)))
                  : ((n.border = o.border), (n.cellpadding = o.cellpadding), (n.cellspacing = o.cellspacing)),
                St(e) && t.children)
              )
                for (let n = 0; n < t.children.length; n++)
                  Xo(l, t.children[n], { 'border-width': fe(o.border), padding: fe(o.cellpadding) }),
                    ft(e) && Xo(l, t.children[n], { 'border-color': o.bordercolor });
              if (ft(e)) {
                const e = o;
                (r['background-color'] = e.backgroundcolor), (r['border-color'] = e.bordercolor), (r['border-style'] = e.borderstyle);
              }
              (n.style = l.serializeStyle({ ...Dt(e), ...r })), l.setAttribs(t, { ...It(e), ...n });
            })(e, t, r);
            const o = n.select('caption', t)[0];
            ((o && !r.caption) || (!o && r.caption)) && e.execCommand('mceTableToggleCaption'), ot(e, t, r.align);
          }
    ...
    Zo = (e, t) => {
      ...
      const a = { type: 'grid', columns: 2, items: Qo(e, r, t) },
        s = ft(e)
          ? { type: 'tabpanel', tabs: [{ title: 'General', name: 'general', items: [a] }, xo(e, 'table')] }
          : { type: 'panel', items: [a] };
      e.windowManager.open({
    ...
    el = e => {
      C(
        { mceTableProps: b(Zo, e, !1), mceTableRowProps: b(Jo, e), mceTableCellProps: b($o, e), mceInsertTableDialog: b(Zo, e, !0) },
        (t, o) =>
          e.addCommand(o, () => {
            return (
              (o = t),
    ...
    nl = e => {
      ...
      const n = ee('caption'),
        ...
        a = () =>
          Jt(ye(e), he(e)).bind(t => {
            return (
              (o = Oe(ze(t), Jt((e => V.fromDom(e.selection.getEnd()))(e), he(e)).bind(ze), (o, l) =>
                $(o, l)
                  ? n(t)
                    ? y.some((e => ({ element: e, mergable: y.none(), unmergable: y.none(), selection: [e] }))(t))
                    : y.some(((e, t, o) => ({ element: o, mergable: ll(t, e, Gt), unmergable: ol(e), selection: tl(e) }))(Xt(e), o, t))
                  : y.none()
              )),
              o.bind(u)
            );
          ...
          ze(e.element).map(t => {
            const o = Qe(t),
              ...
              n = B(
                ...
                (e, t) => (
                  t.isLocked &&
                    ((e.onAny = !0), 0 === t.column ? (e.onFirst = !0) : t.column + t.colspan >= o.grid.columns && (e.onLast = !0)),
                  e
                ),
                { onAny: !1, onFirst: !1, onLast: !1 }
              );
            return { mergeable: Po(o, e).isSome(), unmergeable: ko(o, e).isSome(), locked: n };
          }),
        c = () => {
          t.set(
            (e => {
    ...
    (e => {
      ...
      ((e, t) => {
        ...
        wt(e)
          ...
          : e.ui.registry.addMenuItem('inserttable', { text: 'Table', icon: 'table', onAction: o('mceInsertTableDialog') }),
          e.ui.registry.addMenuItem('inserttabledialog', { text: 'Insert table', icon: 'table', onAction: o('mceInsertTableDialog') }),
          ...
          e.ui.registry.addContextMenu('table', {
            update: () => (
              ...
              t
                .targets()
                .fold(d(''), e =>
                  'caption' === G(e.element) ? 'tableprops deletetable' : 'cell row column | advtablesort | tableprops deletetable'
                )
            ),
          });
        const m = fo(Tt(e));
      ...
      ((e, t) => {
        ...
        l('tableprops', { tooltip: 'Table properties', command: 'mceTableProps', icon: 'table', onSetup: t.onSetupTable }),
          ...
          l('tableinsertdialog', { tooltip: 'Insert table', command: 'mceInsertTableDialog', icon: 'table' });
        const r = fo(Tt(e));
        0 !== r.length &&
          e.queryCommandSupported('mceTableToggleClass') &&
