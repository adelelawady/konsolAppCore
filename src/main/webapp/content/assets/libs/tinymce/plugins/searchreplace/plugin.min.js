  ...
  const I = (e, t) => e.isBlock(t) || E(e.schema.getVoidElements(), t.nodeName),
    ...
    W = (e, t, n, r, o) => {
      ...
      if (
        ((e, t) =>
          ...
          R(e, t) ||
          M(e, t) ||
          ((e, t) => 'true' === e.getContentEditable(t) && t.parentNode && 'false' === e.getContentEditableParent(t.parentNode))(e, t))(
          e,
          n
        )
      )
        ...
        s,
        {
          ...
          cef: t => {
            return ((e, t) => {
              ...
              return (
                n.sort((e, t) =>
                  ((e, t) => ((e, t, n) => 0 != (e.compareDocumentPosition(t) & n))(e, t, Node.DOCUMENT_POSITION_PRECEDING))(
                    e.elements[0].dom,
                    t.elements[0].dom
                  )
                    ? 1
    ...
    ne = (t, n) => {
      ...
      const o = f.trim(t.selection.getContent({ format: 'text' })),
        ...
        u = n.get(),
        m = { findtext: o, replacetext: '', wholewords: u.wholeWord, matchcase: u.matchCase, inselection: u.inSelection },
        p = e => {
          const t = [
            {
              type: 'bar',
        ...
        x = (e, r) => ({
          ...
          initialData: r,
          onChange: (t, r) => {
            e && t.redial(x(!1, t.getData())), 'findtext' === r.name && n.get().count > 0 && c(t);
          },
          onAction: (e, r) => {
            const o = e.getData();
            switch (r.name) {
      ...
      r.set(t.windowManager.open(x(!1, m), { inline: 'toolbar' }));
    },
    re = (e, t) => () => {
      ne(e, t);
    };
    ...
    return (
      ...
      ((e, t) => {
        e.ui.registry.addMenuItem('searchreplace', { text: 'Find and replace...', shortcut: 'Meta+F', onAction: re(e, t), icon: 'search' }),
          e.ui.registry.addButton('searchreplace', { tooltip: 'Find and replace', onAction: re(e, t), icon: 'search' }),
