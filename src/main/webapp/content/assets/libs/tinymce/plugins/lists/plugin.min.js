...
!(function () {
  ...
  const t = e => t =>
      (e => {
        ...
        return null === e
          ...
          : 'object' === t &&
            ((n = r = e),
            (o = String).prototype.isPrototypeOf(n) || (null === (s = r.constructor) || void 0 === s ? void 0 : s.name) === o.name)
          ? 'string'
          : t;
        var n, r, o, s;
      })(t) === e,
  ...
  const ue = e => t => l(t) && t.nodeName.toLowerCase() === e,
    ...
    Ee = (e, t) => {
      ...
      let l,
        a,
        d = !1;
      for (a = n.create(s, i), Le(t.firstChild, r) || o.appendChild(a); (l = t.firstChild); ) {
        const e = l.nodeName;
        d || ('SPAN' === e && 'bookmark' === l.getAttribute('data-mce-type')) || (d = !0),
          Le(l, r) ? (o.appendChild(l), (a = null)) : (a || ((a = n.create(s, i)), o.appendChild(a)), a.appendChild(l));
      }
      return !d && a && a.appendChild(n.create('br', { 'data-mce-bogus': '1' })), o;
    },
    Be = de.DOM,
    Ie = F('dd'),
    Pe = F('dt'),
        ...
        : Pe(t) &&
          ((n = t), g.from(n.dom.parentElement).map(R)).each(n =>
            ((e, t, n) => {
              ...
              e.dom.isEmpty(i) || Be.insertAfter(i, t), Be.insertAfter(o, t);
    ...
    Ke = (e, t) => {
      const n = e.dom.getParents(t, e.dom.isBlock),
        r = k(n, t => {
          return (n = e.schema), !he((r = t)) && !ve(r) && C(_e, e => n.isValidChild(r.nodeName, e));
          var n, r;
        });
  ...
  const tt = (e, t, n) => {
    ...
    dt = e => (
      S(e, (t, n) => {
        ((e, t) => {
          ...
          e => {
            return (r = e), ((n = t).listType = r.listType), void (n.listAttributes = { ...r.listAttributes });
            var n, r;
          }
        );
      }),
          ...
          (t, n) =>
            n.depth > t.length
              ? ((e, t, n) => {
                  const r = ((e, t, n) => {
                    const r = [];
                    for (let o = 0; o < n; o++) r.push(rt(e, t.listType));
                    return r;
    ...
    pt = (e, t, n) => {
      const r = ((e, t) => {
        ...
        (e => {
          const t = b(Ve(e), R);
          return I(k(t, m(st)), k(A(t), m(st)), (e, t) => ({ start: e, end: t }));
        })(e)
      );
      S(r, t => {
        ((e, t) => {
  ...
  const St = de.DOM,
      ...
      const t = {},
        n = n => {
          ...
          if (ge(r)) {
            ...
            r.hasChildNodes()
              ? ((o = Math.min(o, r.childNodes.length - 1)), n ? r.insertBefore(e, r.childNodes[o]) : St.insertAfter(e, r.childNodes[o]))
              : r.appendChild(e),
              (r = e),
              (o = 0);
          }
          (t[n ? 'startContainer' : 'endContainer'] = r), (t[n ? 'startOffset' : 'endOffset'] = o);
        };
        ...
        if (n) {
          if (ge(n) && n.parentNode) {
            ...
            (r = (e => {
              ...
              for (; n; ) {
                if (n === e) return r;
                (ge(n) && 'bookmark' === n.getAttribute('data-mce-type')) || r++, (n = n.nextSibling);
              }
              return -1;
            })(n)),
              (n = n.parentNode),
          ...
          (e[t ? 'startContainer' : 'endContainer'] = n), (e[t ? 'startOffset' : 'endOffset'] = r);
        }
      };
      t(!0), t();
    ...
    xt = (e, t, n, r) => {
      ...
      ge(o) && (o = o.childNodes[Math.min(s, o.childNodes.length - 1)] || o), !n && Se(o.nextSibling) && (o = o.nextSibling);
      const i = (t, n) => {
        var o;
        const s = new ee(t, r),
          i = n ? 'next' : 'prev';
        let l;
        for (; (l = s[i]()); )
          if (!Oe(e, l) && !Ct(l.textContent) && 0 !== (null === (o = l.textContent) || void 0 === o ? void 0 : o.length)) return g.some(l);
        return g.none();
      };
      if (n && pe(o))
        if (Ct(o.textContent)) o = i(o, !1).getOr(o);
        else
          for (
            null !== o.parentNode && At(e, o.parentNode) && (o = o.parentNode);
            null !== o.previousSibling && (At(e, o.previousSibling) || pe(o.previousSibling));

          )
            o = o.previousSibling;
      if (!n && pe(o))
        if (Ct(o.textContent)) o = i(o, !0).getOr(o);
        else
          for (
            null !== o.parentNode && At(e, o.parentNode) && (o = o.parentNode);
            null !== o.nextSibling && (At(e, o.nextSibling) || pe(o.nextSibling));
      ...
      for (; o.parentNode !== r; ) {
        ...
        if (Ne(e, o)) return o;
        if (/^(TD|TH)$/.test(t.nodeName)) return o;
        o = t;
      }
      return o;
    },
      ...
      const l = Nt(r),
        a = ((e, t, n) => {
          ...
          return (
            ce.each(a, t => {
              var s;
              if (Ne(e, t)) return r.push(t), void (l = null);
              if (o.isBlock(t) || Se(t)) return Se(t) && o.remove(t), void (l = null);
              const i = t.nextSibling;
              bt.isBookmarkNode(t) && (he(i) || Ne(e, i) || (!i && t.parentNode === n))
                ? (l = null)
                : (l || ((l = o.create('p')), null === (s = t.parentNode) || void 0 === s || s.insertBefore(l, t), r.push(l)),
                  l.appendChild(t));
            }),
            r
          );
      ...
      ce.each(a, r => {
        ...
        ve(a) ||
          ...
          ((e, t, n) => {
            ...
            ? ((s = l), (r = i.rename(r, o)), l.appendChild(r))
            : ((s = i.create(t)), a.insertBefore(s, r), s.appendChild(r), (r = i.rename(r, o))),
          ((e, t, n) => {
            ce.each(
              [
                'margin',
    ...
    Et = (e, t) => {
      ...
      if (((r = t.previousSibling), Dt(e, t, r))) {
        const o = r;
        for (; (n = o.lastChild); ) t.insertBefore(n, t.firstChild);
        e.remove(o);
      }
    },
    ...
    It = (e, t, n) => {
      const r = He(e);
      if (Ge(e, r) || (e => C(e.selection.getSelectedBlocks(), m(e.dom.isEditable)))(e)) return;
      const s = (e => {
          const t = He(e),
              ...
              ce.each(l, t => {
                ((e, t, n, r) => {
                  if (t.nodeName !== n) {
                    ...
                    Tt(e.dom, o, r), Xe(e, Ot(n), o);
                  } else Tt(e.dom, t, r), Xe(e, Ot(n), t);
                })(e, t, r, o);
              }),
            ...
            if (t !== e.getBody())
              if (t)
                if (t.nodeName !== n || Bt(r) || qe(t)) {
                  ...
                  Et(e.dom, s), e.selection.setRng(Lt(o)), wt(e, n, r), Xe(e, Ot(n), s);
                } else vt(e);
              else wt(e, n, r), Xe(e, Ot(n), t);
          })(e, r, t, i);
    },
    Pt = de.DOM,
    Mt = (e, t) => {
      ...
      ce.each(n, t => {
        ((e, t) => {
          ...
          if (n && 'LI' === n.nodeName && n.firstChild === t) {
            ...
            r && 'LI' === r.nodeName ? (r.appendChild(t), ke(e, n) && Pt.remove(n)) : Pt.setStyle(n, 'listStyleType', 'none');
          }
          if (he(n)) {
    ...
    Rt = (e, t, n, r) => {
      ...
      if (pe(o) && (n ? s < o.data.length : s > 0)) return o;
      ...
      for (; (o = a()); ) {
        ...
        if (pe(o) && o.data.length > 0) return o;
      }
      return null;
    },
    Ut = (e, t) => {
    ...
    $t = (e, t, n) => {
      ...
      he(n.lastChild) && (r = n.lastChild), o === n.lastChild && Se(o.previousSibling) && e.remove(o.previousSibling);
      const s = n.lastChild;
    ...
    _t = (e, t) => {
      ...
      if (i) {
        ...
        if (o === e.getBody() && ke(n, o)) return !0;
        const l = $e(r.getRng()),
            ...
            e.undoManager.transact(() => {
              ...
              t
                ? ((e, t, n, r) => {
                    ...
                    if (o.isEmpty(r))
                      ((e, t, n) => {
                        J(R(n)), $t(e.dom, t, n), e.selection.setCursorLocation(n, 0);
                      })(e, n, r);
                    else {
                      const s = Nt(t);
                      $t(o, n, r), e.selection.setRng(Lt(s));
                    }
                  })(e, l, a, i)
                : (null === (r = (n = i).parentNode) || void 0 === r ? void 0 : r.firstChild) === n
                ? yt(e)
                : ((e, t, n, r) => {
                    const o = Nt(t);
                    $t(e.dom, n, r);
      ...
      return (
        ...
        (n.isCollapsed()
                ...
                if (s && n.isEmpty(s)) {
                  ...
                  if (i) {
                    const l = e => v(['td', 'th', 'caption'], $(e)),
                      a = e => e.dom === o;
                    return (
                      !!((e, t, n = u) => I(e, t, n).getOr(e.isNone() && t.isNone()))(q(R(i), l, a), q(R(r.startContainer), l, a), U) &&
                      (e.undoManager.transact(() => {
                        ((e, t, n) => {
          ...
          : (e =>
              !!Ft(e) &&
              (e.undoManager.transact(() => {
                e.execCommand('Delete'), Mt(e.dom, e.getBody());
              }),
              !0))(e))
      );
    },
        ...
        (e => {
          ...
          ye(t) &&
            ...
            e.windowManager.open({
              ...
              initialData: {
                start: Kt({ start: e.dom.getAttrib(t, 'start', '1'), listStyleType: g.from(e.dom.getStyle(t, 'list-style-type')) }),
              },
              buttons: [
              ...
              onSubmit: t => {
                (e => {
                  switch ((e => (/^[0-9]+$/.test(e) ? 2 : /^[A-Z]+$/.test(e) ? 0 : /^[a-z]+$/.test(e) ? 1 : e.length > 0 ? 4 : 3))(e)) {
                    ...
                    case 0:
                      return g.some({ listStyleType: g.some('upper-alpha'), start: Vt(e).toString() });
                    case 1:
                      return g.some({ listStyleType: g.some('lower-alpha'), start: Vt(e).toString() });
                    case 3:
  ...
  const Wt = e => 3 === e.type,
    ...
    Gt = e => {
      const t = (t, n) => {
          ...
          S(t, e => r.append(e)), n ? e.insert(r, n, !0) : e.append(r);
        },
    ...
    Jt = (e, t) => n =>
      Je(e, r => {
        n.setActive(We(r.parents, t)), n.setEnabled(!Ge(e, r.element));
      }),
  ...
  e.add(
    ...
    e => (
                ...
                e.on('ExecCommand', t => {
                  ...
                  e.on('keydown', t => {
                    t.keyCode === te.BACKSPACE
                      ? Ht(e, !1) && t.preventDefault()
                      : t.keyCode === te.DELETE && Ht(e, !0) && t.preventDefault();
                  });
              })(e);
          })(e),
          (e => {
                ...
                o(n) &&
                  ((e, t) => {
                    ...
                    null === n ||
                      Ge(e, n) ||
                      e.undoManager.transact(() => {
                        o(t.styles) && e.dom.setStyles(n, t.styles), o(t.attrs) && oe(t.attrs, (t, r) => e.dom.setAttrib(n, r, t));
                      });
                  })(e, n);
              }),
      ...
      (e => {
        const t = { text: 'List properties...', icon: 'ordered-list', onAction: () => e.execCommand('mceListProps'), onSetup: Xt(e, 'OL') };
