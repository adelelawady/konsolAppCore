...
!(function () {
    ...
    t =>
      ...
      (t => {
        ...
        return null === t
          ...
          : 'object' === e &&
            ((r = o = t),
            (a = String).prototype.isPrototypeOf(r) || (null === (s = o.constructor) || void 0 === s ? void 0 : s.name) === a.name)
          ? 'string'
          : e;
        var r, o, a, s;
      })(t));
  ...
  t.add(
    ...
    t => (
      ...
      (t => ({ hasDraft: () => f(t), storeDraft: () => g(t), restoreDraft: () => y(t), removeDraft: e => p(t, e), isEmpty: e => v(t, e) }))(
        t
      )
    )
  );
