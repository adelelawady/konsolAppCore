    ...
    o = t =>
      ...
      (t => {
        ...
        return null === t
          ...
          : 'object' === e &&
            ((o = r = t),
            (n = String).prototype.isPrototypeOf(o) || (null === (i = r.constructor) || void 0 === i ? void 0 : i.name) === n.name)
          ? 'string'
          : e;
        var o, r, n, i;
      })(t),
  ...
  const m = t => e => (t => t.dom.nodeType)(e) === t,
    ...
    b = t => {
      ...
      return (t => {
        ...
        var o;
      })(d(e)).fold(() => o.body.contains(e), ((r = b), (i = N), t => r(i(t))));
      var r, i;
    },
    S = t =>
      'rtl' ===
  ...
  const C = (t, e) => {
      ...
      n.length > 0 &&
        (u(n, t => {
          ...
          var f;
          ((f = m), (t => a.from(t.dom.parentNode).map(d))(f).filter(g)).each(t => {
            if (
              (S(t) !== e
                ? ((t, e, n) => {
                    ((t, e, n) => {
