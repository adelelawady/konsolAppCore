...
!(function () {
  ...
  const t = e => t =>
      (e => {
        ...
        return null === e
          ...
          : 'object' === t &&
            ((r = a = e),
            (o = String).prototype.isPrototypeOf(r) || (null === (s = a.constructor) || void 0 === s ? void 0 : s.name) === o.name)
          ? 'string'
          : t;
        var r, a, o, s;
      })(t) === e,
  ...
  const n = Array.prototype.push,
    ...
    l = e => {
      ...
      for (let r = 0, a = e.length; r < a; ++r) {
        if (!o(e[r])) throw new Error('Arr.flatten item ' + r + ' was not an array, input: ' + e);
        n.apply(t, e[r]);
      }
      return t;
    },
  ...
  const S = O.DOM,
    ...
    T = (e, t) => {
      let r = {};
      for (let a = A({ validate: !1, forced_root_block: !1 }, t).parse(e); a; a = a.walk())
        if (1 === a.type) {
          const e = a.name;
  ...
  const F = (e, t = {}) => A({ forced_root_block: !1, validate: !1, allow_conditional_comments: !0, ...t }, e),
    N = O.DOM,
    R = e => (/^[0-9.]+$/.test(e) ? e + 'px' : e),
    U = (e, t) => {
      const r = t.attr('style'),
        a = r ? N.parseStyle(r) : {};
      s(e.width) && (a['max-width'] = R(e.width)), s(e.height) && (a['max-height'] = R(e.height)), t.attr('style', N.serializeStyle(a));
    },
    P = ['source', 'altsource'],
    E = (e, t, r, a) => {
      let o = 0,
          ...
          if (r)
            switch (a) {
              case 'video':
                ...
                for (let r = o; r < 2; r++)
                  if (t[P[r]]) {
                    ...
                    a.attr('src', t[P[r]]), a.attr('type', t[P[r] + 'mime'] || null), e.append(a);
                  }
                break;
              case 'iframe':
                e.attr('src', t.source);
              ...
              case 'object':
                ...
                break;
              case 'source':
                if (s < 2 && (e.attr('src', t[P[s]]), e.attr('type', t[P[s] + 'mime'] || null), !t[P[s]])) {
                  e.remove();
                  continue;
                }
                s++;
    ...
    I = (e, t) => {
      const r = (e => {
        ...
        a = e.regex.exec(t);
      let o = r + e.url;
      if (s(a)) for (let e = 0; e < a.length; e++) o = o.replace('$' + e, () => (a[e] ? a[e] : ''));
      return o.replace(/\?$/, '');
    },
    B = (e, t) => {
      var r;
      const a = k.extend({}, t);
      if (!a.source && (k.extend(a, T(null !== (r = a.embed) && void 0 !== r ? r : '', e.schema)), !a.source)) return '';
        ...
        return E(a.embed, a, !0, e.schema);
      {
        ...
        return (
          ...
          'iframe' === a.type
            ...
            ? (e => {
                let t =
                  '<object data="' + e.source + '" width="' + e.width + '" height="' + e.height + '" type="application/x-shockwave-flash">';
                return (
    ...
    H = (e, t) => {
      ...
      return r
        ? ((e, t, r) =>
            new Promise((a, o) => {
              const s = r => (r.html && (W[e.source] = r), a({ url: e.source, html: r.html ? r.html : t(e) }));
    ...
    K = (e, t) => {
      const r = t && 'dimensions' !== t ? ((e, t) => d(t, e).bind(e => d(e, 'meta')))(t, e).getOr({}) : {},
        o = ((e, t, r) => o => {
          ...
          return {
            [o]: (o === r
              ? s().bind(e => (a(e) ? c(e).orThunk(n) : n().orThunk(() => i.from(e))))
              : n().orThunk(() => s().bind(e => (a(e) ? c(e) : i.from(e))))
            ).getOr(''),
          };
        })(e, r, t);
      return { ...o('source'), ...o('altsource'), ...o('poster'), ...o('embed'), ...J(e, r) };
    },
    Q = e => {
      const t = {
        ...e,
    ...
    Y = (e, t) => {
      ...
      e.insertContent(t),
        ((e, t) => {
          const r = e.dom.select('*[data-mce-object]');
          for (let e = 0; e < t.length; e++) for (let a = r.length - 1; a >= 0; a--) t[e] === r[a] && r.splice(a, 1);
    ...
    Z = e => {
      const t = (e => {
        ...
        a = Q(t),
        o = j(e) ? [{ type: 'sizeinput', name: 'dimensions', label: 'Constrain proportions', constrain: !0 }] : [],
        s = {
          title: 'General',
          name: 'general',
          items: l([[{ name: 'source', type: 'urlinput', filetype: 'media', label: 'Source' }], o]),
        },
        i = [];
      ...
      const n = { title: 'Advanced', name: 'advanced', items: i },
        c = [s, { title: 'Embed', items: [{ type: 'textarea', name: 'embed', label: 'Paste your embed code below:' }] }];
      i.length > 0 && c.push(n);
            ...
            switch (a.name) {
              case 'source':
                ((t, r) => {
                  ...
                  t.source !== a.source && (X(u, e)({ url: a.source, html: '' }), H(e, a).then(X(u, e)).catch(V(e)));
                })(r.get(), t);
                break;
              case 'embed':
                (t => {
  ...
  const te = e => {
    ...
    oe = (e, t) => {
      ...
      return (
        ie(e, t, a),
        ae(t, a, {}),
        a.attr({ style: t.attr('style'), src: ee.transparentSrc, 'data-mce-object': r, class: 'mce-object mce-object-' + r }),
        a
      );
    },
    se = (e, t) => {
      ...
      const a = t.name,
        o = new $('span', 1);
      o.attr({ contentEditable: 'false', style: t.attr('style'), 'data-mce-object': a, class: 'mce-preview-object mce-object-' + a }),
        ie(e, t, o);
      const i = e.dom.parseStyle(null !== (r = t.attr('style')) && void 0 !== r ? r : ''),
        n = new $(a, 1);
      if ((ae(t, n, i), n.attr({ src: t.attr('src'), style: t.attr('style'), class: t.attr('class') }), 'iframe' === a))
    ...
    ie = (e, t, r) => {
      ...
      for (; s--; ) {
        ...
        'width' === t ||
          'height' === t ||
          'style' === t ||
          ((n = 'data-mce-'), (i = t).length >= n.length && i.substr(0, 0 + n.length) === n) ||
          (('data' !== t && 'src' !== t) || (a = e.convertURL(a, t)), r.attr('data-mce-p-' + t, a));
      }
      var i, n;
    ...
    ce = e => {
      let t = e;
      for (; (t = t.parent); ) if (t.attr('data-ephox-embed-iri') || ne(t)) return !0;
      return !1;
    },
    le = (e, t, r) => {
      const a = (0, e.options.get)('xss_sanitization'),
        o = f(e);
      return F(e.schema, { sanitize: a, validate: o }).parse(r, { context: t });
    };
  e.add(
    'media',
    e => (
      ...
      (e => {
        ...
        e.ui.registry.addToggleButton('media', {
          ...
          e.ui.registry.addMenuItem('media', { icon: 'embed', text: 'Media...', onAction: t });
      })(e),
      (e => {
        e.on('ResolveName', e => {
          let t;
            ...
            a.addNodeFilter(
              ...
              (e => t => {
                ...
                for (; a--; )
                  (r = t[a]),
                    r.parent &&
                      (r.parent.attr('data-mce-object') || (te(r) && v(e) ? ce(r) || r.replace(se(e, r)) : ce(r) || r.replace(oe(e, r))));
              })(e)
            ),
        ...
        e.on('click keyup touchend', () => {
          ...
          e.on('ObjectResized', t => {
            ...
            if (r.getAttribute('data-mce-object')) {
              ...
              a &&
                ((a = unescape(a)),
                r.setAttribute('data-mce-html', escape(E(a, { width: String(t.width), height: String(t.height) }, !1, e.schema))));
            }
          });
      })(e),
      (e => ({
