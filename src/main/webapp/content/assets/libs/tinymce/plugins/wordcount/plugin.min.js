...
!(function () {
    ...
    S = (t, e, n) => {
      ...
      return ((t, e, n, o) => {
        ...
        for (let u = 0; u < n.length; ++u)
          if ((c.push(t[u]), f(n, u))) {
            const n = e[u];
            if ((o.includeWhitespace || !W.test(n)) && (o.includePunctuation || !x.test(n))) {
  ...
  ((e = 300) => {
    t.add('wordcount', t => {
      const n = (t => ({
        body: { getWordCount: k(t), getCharacterCount: D(t, A), getCharacterCountWithoutSpaces: D(t, B) },
        selection: { getWordCount: j(t, T), getCharacterCount: j(t, A), getCharacterCountWithoutSpaces: j(t, B) },
        getCount: k(t),
      }))(t);
      return (
        ((t, e) => {
