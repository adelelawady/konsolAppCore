...
!(function () {
  ...
  const t = e => t =>
      (e => {
        ...
        return null === e
          ...
          : 'object' === t &&
            ((a = n = e),
            (r = String).prototype.isPrototypeOf(a) || (null === (s = n.constructor) || void 0 === s ? void 0 : s.name) === r.name)
          ? 'string'
          : t;
        var a, n, r, s;
      })(t) === e,
  ...
  const c = e => t => t.options.get(e),
    ...
    M = (e, t, a = new Date()) => {
      ...
      return (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace('%D', '%m/%d/%Y')).replace(
        '%r',
        '%I:%M:%S %p'
      )).replace('%Y', '' + a.getFullYear())).replace('%y', '' + a.getYear())).replace('%m', b(a.getMonth() + 1, 2))).replace(
        '%d',
        b(a.getDate(), 2)
      )).replace('%H', '' + b(a.getHours(), 2))).replace('%M', '' + b(a.getMinutes(), 2))).replace(
        '%S',
        '' + b(a.getSeconds(), 2)
  ...
  var S = tinymce.util.Tools.resolve('tinymce.html.Serializer');
  const w = { '"': '&quot;', '<': '&lt;', '>': '&gt;', '&': '&amp;', "'": '&#039;' },
    C = e =>
      e.replace(/["'<>&]/g, e => {
        return ((t = w), (a = e), ((e, t) => x.call(e, t))(t, a) ? T.from(t[a]) : T.none()).getOr(e);
        var t, a;
      }),
    O = (e, t, a) =>
      ((a, n) => {
    ...
    A = (e, t) => S({ validate: !0 }, e.schema).serialize(e.parser.parse(t, { insert: !0 })),
    D = (e, t) => (
      o.each(t, (t, a) => {
    ...
    N = (e, t, a) => {
      ...
      l && l.length > 0 && ((s = n.create('div')), s.appendChild(l[0].cloneNode(!0))),
        o.each(n.select('*', s), t => {
          O(n, t, i(e)) && (t.innerHTML = M(e, g(e))), O(n, t, u(e)) && (t.innerHTML = M(e, v(e))), O(n, t, m(e)) && (t.innerHTML = r);
        }),
        I(e, s),
      ...
      return T.from(
        o.map(t, (e, t) => {
          ...
          return {
            selected: 0 === t,
            text: e.title,
            value: { url: a(e) ? T.from(e.url) : T.none(), content: a(e) ? T.none() : T.from(e.content), description: e.description },
          };
        })
      );
    })().each(t => {
      const a = (e =>
        ...
        i = (t, n, r) => {
          const s = ((e, t) => {
              ...
              if (-1 === t.indexOf('<html>')) {
                let n = '';
                const r = null !== (a = y(e)) && void 0 !== a ? a : '',
                  s = f(e) ? ' crossorigin="anonymous"' : '';
                o.each(e.contentCSS, t => {
                  n += '<link type="text/css" rel="stylesheet" href="' + e.documentBaseURI.toAbsolute(t) + '"' + s + '>';
                }),
                ...
                const l = _(e),
                  ...
                  i =
                    ...
                    (k.os.isMacOS() || k.os.isiOS() ? 'e.metaKey' : 'e.ctrlKey && !e.altKey') +
            ...
            c = [
              { type: 'selectbox', name: 'template', label: 'Templates', items: a },
              { type: 'htmlpanel', html: `<p aria-live="polite">${C(n.value.description)}</p>` },
  ...
  e.add('template', e => {
    (e => {
      ...
      (e => {
        ...
        e.ui.registry.addButton('template', { icon: 'template', tooltip: 'Insert template', onAction: t }),
          e.ui.registry.addMenuItem('template', { icon: 'template', text: 'Insert template...', onAction: t });
      })(e),
      (e => {
        e.addCommand(
          'mceInsertTemplate',
