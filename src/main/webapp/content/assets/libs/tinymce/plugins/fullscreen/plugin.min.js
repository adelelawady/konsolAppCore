  ...
  const L = e => t => (e => e.dom.nodeType)(t) === e,
    ...
    me = e => {
      const t = e.current,
        n = e.version,
        r = e => () => t === e;
      return { current: t, version: n, isEdge: r(le), isChromium: r(ae), isIE: r('IE'), isOpera: r(ce), isFirefox: r(ue), isSafari: r(de) };
    },
          ...
          o = ((e, t) => {
            ...
            (document.body.scrollTop = 0),
              ...
              window.requestAnimationFrame(() => {
                t.on(t => K(t, { top: e.offsetTop + 'px', left: e.offsetLeft + 'px', height: e.height + 'px', width: e.width + 'px' }));
              });
          });
        return {
          bind: e => {
      ...
      t.inline ||
        ...
        ((e, t) => {
          ...
          e.ui.registry.addToggleMenuItem('fullscreen', {
            ...
            e.ui.registry.addToggleButton('fullscreen', { tooltip: 'Fullscreen', icon: 'fullscreen', onAction: n, onSetup: Ye(e, t) });
        })(t, n),
