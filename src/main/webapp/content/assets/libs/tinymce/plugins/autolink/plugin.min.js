      ...
      e =>
        ...
        (e => {
          ...
          return null === e
            ...
            : 'object' === t &&
              ((n = o = e),
              (r = String).prototype.isPrototypeOf(n) || (null === (a = o.constructor) || void 0 === a ? void 0 : a.name) === r.name)
            ? 'string'
            : t;
          var n, o, r, a;
        })(e));
  ...
  const f = e => /^[(\[{ \u00a0]$/.test(e),
    ...
    m = (e, t) => {
      ...
      const m = d.getRng(),
        ...
        h = null !== (o = i.getParent(p, i.isBlock)) && void 0 !== o ? o : i.getRoot(),
        w = k.backwards(
          p,
          y + t,
          (e, t) => {
      ...
      const _ = k.backwards(
        ...
        A = i.createRng();
      _ ? A.setStart(_.container, _.offset) : A.setStart(v, 0), A.setEnd(w.container, w.offset);
      const C = A.toString()
        .replace(/\uFEFF/g, '')
        .match(s);
      if (C) {
