  ...
  e.add('pagebreak', e => {
    (e => {
      ...
      (e => {
        ...
        e.ui.registry.addButton('pagebreak', { icon: 'page-break', tooltip: 'Page break', onAction: a }),
          e.ui.registry.addMenuItem('pagebreak', { text: 'Page break', icon: 'page-break', onAction: a });
      })(e),
      (e => {
        const a = r(e),
          t = () => n(e),
