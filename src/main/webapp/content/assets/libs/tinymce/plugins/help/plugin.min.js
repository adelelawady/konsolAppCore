...
!(function () {
      ...
      e =>
        ...
        (e => {
          ...
          return null === e
            ...
            : 'object' === t &&
              ((n = a = e),
              (o = String).prototype.isPrototypeOf(n) || (null === (i = a.constructor) || void 0 === i ? void 0 : i.name) === o.name)
            ? 'string'
            : t;
          var n, a, o, i;
        })(e));
  ...
  var T = tinymce.util.Tools.resolve('tinymce.util.I18n');
  const x = p(
      [
    ...
    C = e => {
      const t = e => `<a href="${e.url}" target="_blank" rel="noopener">${e.name}</a>`,
        n = (e, n) => {
          return ((a = x),
          (o = e => e.key === n),
          ((e, t, n) => {
        ...
        a = e => {
          const t = (e => {
              const t = y(e.plugins),
                n = i(e);
              return s(n) ? t : d(t, e => !(((e, t) => h.call(e, t))(n, e) > -1));
            })(e),
            a = g(
              p(t, t => n(e, t)),
              (e, t) => e.name.localeCompare(t.name)
            ),
            o = p(a, e => '<li>' + e.html + '</li>'),
            r = o.length,
            l = o.join('');
          return '<p><b>' + T.translate(['Plugins installed ({0}):', r]) + '</b></p><ul>' + l + '</ul>';
        },
        o = {
          type: 'htmlpanel',
          presets: 'document',
          html: [
            (e => (null == e ? '' : '<div data-mce-tabstop="1" tabindex="-1">' + a(e) + '</div>'))(e),
            (() => {
              const e = d(x, ({ type: e }) => 'premium' === e),
                t = g(
                  p(e, e => e.name),
      ...
      return { name: 'plugins', title: 'Plugins', items: [o] };
    };
  var M = tinymce.util.Tools.resolve('tinymce.EditorManager');
  const S = (e, t) => () => {
    const { tabs: a, names: i } = ((e, t) => {
        const a = A(),
          i = {
            name: 'keyboardnav',
          ...
          l = (() => {
            ...
            const n =
              ...
              ((e = M.majorVersion), (t = M.minorVersion), (0 === e.indexOf('@') ? 'X.X.X' : e + '.' + t) + '</a>');
            return {
              name: 'versions',
              title: 'Version',
              items: [{ type: 'htmlpanel', html: '<p>' + T.translate(['You are using {0}', n]) + '</p>', presets: 'document' }],
            };
          })(),
          c = { [a.name]: a, [i.name]: i, [s.name]: s, [l.name]: l, ...t.get() };
        return u.from(o(e)).fold(
          () =>
            (e => {
              const t = y(e),
          ...
          e =>
            ((e, t) => {
              const a = {},
                o = p(e, e => {
                  var o;
                  if (r(e)) return k(t, e) && (a[e] = t[e]), e;
                  {
                    const t = null !== (o = e.name) && void 0 !== o ? o : n('tab-name');
                    return (a[t] = e), t;
                  }
                });
              return { tabs: a, names: o };
            })(e, c)
        );
      })(e, t),
      s = {
        ...
        tabs: (e => {
          ...
          p(i, e => {
            return k((t = a), (n = e)) ? u.from(t[n]) : u.none();
            var t, n;
          })
        ),
      };
  ...
  e.add('help', e => {
    const t = (e => {
      ...
      a = (e => ({
        addTab: t => {
          var a;
          const o = null !== (a = t.name) && void 0 !== a ? a : n('tab-name'),
            i = e.get();
          (i[o] = t), e.set(i);
        },
      }))(t);
