  ...
  var t = {
      ...
      './src/fuzzy-search.js': function (t, e, r) {
        ...
        t.exports = function (t, e) {
          e = s({ location: 0, distance: 100, threshold: 0.4, multiSearch: !0, searchClass: 'fuzzy-search' }, (e = e || {}));
          var r = {
            search: function (n, s) {
          ...
          (d = {
            start: function () {
              (v.listClass = 'list'),
                ...
                v.listContainer &&
                  ...
                  (v.fuzzySearch = r('./src/fuzzy-search.js')(v, e.fuzzySearch)),
                  this.handlers(),
                  this.items(),
                  this.pagination(),
                  v.update());
            ...
            (this.remove = function (t, e, r) {
              for (var n = 0, s = 0, i = v.items.length; s < i; s++)
                v.items[s].values()[t] == e && (v.templater.remove(v.items[s], r), v.items.splice(s, 1), i--, s--, n++);
              return v.update(), n;
            }),
            ...
            r = function (r, s) {
              ...
              for (var g = 1; g <= c; g++) {
                ...
                a.number(g, d, v, f, h)
                  ...
                  : a.dotted(r, g, d, v, f, h, r.size()) && ((i = r.add({ page: '...', dotted: !0 })[0]), n(i.elm).add('disabled'));
              }
            },
            a = {
          ...
          var e,
            ...
            i = function () {
              for (var n, s = [], i = r; null !== (n = i.match(/"([^"]+)"/)); )
                s.push(n[1]), (i = i.substring(0, n.index) + i.substring(n.index + n[0].length));
        ...
        var e = function (t) {
          var e,
            ...
            n = function (e, r) {
              ...
              for (var s = 0, i = r.length; s < i; s++) {
                var a = void 0,
                  o = r[s];
                if (o.data) for (var l = 0, u = o.data.length; l < u; l++) n.setAttribute('data-' + o.data[l], '');
                else
                  o.attr && o.name
                    ? (a = t.utils.getByClass(n, o.name, !0)) && a.setAttribute(o.attr, '')
            ...
            a = function (e, r, n) {
              ...
              i &&
                (i.data
                  ...
                  : i.attr && i.name
                  ? (s = t.utils.getByClass(e.elm, i.name, !0)) && s.setAttribute(i.attr, n)
                  : (s = t.utils.getByClass(e.elm, i, !0)) && (s.innerHTML = n));
            };
          (this.get = function (e, n) {
            ...
            for (var s = {}, i = 0, a = n.length; i < a; i++) {
              var o = void 0,
                l = n[i];
              if (l.data) for (var u = 0, c = l.data.length; u < c; u++) s[l.data[u]] = t.utils.getAttribute(e.elm, 'data-' + l.data[u]);
              else
                l.attr && l.name
                  ? ((o = t.utils.getByClass(e.elm, l.name, !0)), (s[l.name] = o ? t.utils.getAttribute(o, l.attr) : ''))
                  : ((o = t.utils.getByClass(e.elm, l, !0)), (s[l] = o ? o.innerHTML : ''));
            }
            return s;
          }),
        ...
        t.exports = function (t, e, r) {
          ...
          for (var v, g = e.length + t.length, m = 0; m < e.length; m++) {
            ...
            for (var b = y; b >= p; b--) {
              ...
              if (
                ((C[b] = 0 === m ? ((C[b + 1] << 1) | 1) & j : (((C[b + 1] << 1) | 1) & j) | ((v[b + 1] | v[b]) << 1) | 1 | v[b + 1]),
                C[b] & d)
              ) {
                var x = l(m, b - 1);
                if (x <= u) {
      ...
      './src/utils/get-by-class.js': function (t) {
        t.exports = function (t, e, r, n) {
          return ((n = n || {}).test && n.getElementsByClassName) || (!n.test && document.getElementsByClassName)
            ...
            : (function (t, e, r) {
                for (
                  var n = [], s = t.getElementsByTagName('*'), i = s.length, a = new RegExp('(^|\\s)' + e + '(\\s|$)'), o = 0, l = 0;
                  o < i;
                  o++
                )
