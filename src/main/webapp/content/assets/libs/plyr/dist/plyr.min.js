  ...
  (function (e, t) {
    ...
    const z = {
      ...
      K = {
        ...
        pip: !(
          M.isIPhone ||
          (!S.function($('video').webkitSetPresentationMode) && (!document.pictureInPictureEnabled || $('video').disablePictureInPicture))
        ),
    ...
    function Q(e, t, i, s = !1, n = !0, a = !1) {
      ...
      Y && (r = { passive: n, capture: a }),
        l.forEach(t => {
          this && this.eventListeners && s && this.eventListeners.push({ element: e, type: t, callback: i, options: r }),
    ...
    const Pe = {
      ...
      createProgress(e, t) {
        const i = $(
          'progress',
          x(D(this.config.selectors.display[e]), { min: 0, max: 100, value: 0, role: 'progressbar', 'aria-hidden': !0 }, t)
        );
        if ('volume' !== e) {
      ...
      setCaptionsMenu() {
        ...
        n.unshift({ value: -1, checked: !this.captions.toggled, title: ve.get('disabled', this.config), list: t, type: 'language' }),
            ...
            if (
              ...
              if (
                ((S.element(t) && c.contains(t)) ||
                  ((t = $('div', x({}, u, { class: `${u.class} plyr__volume`.trim() }))), (this.elements.volume = t), c.appendChild(t)),
    ...
    class He {
      ...
      static get prefix() {
        ...
        return (
          ['webkit', 'moz', 'ms'].some(
            t => !(!S.function(document[`${t}ExitFullscreen`]) && !S.function(document[`${t}CancelFullScreen`])) && ((e = t), !0)
          ),
          e
        );
      }
        ...
        if (
          (e(this, 'play', () =>
            S.function(this.media.play)
              ? (this.ads && this.ads.enabled && this.ads.managerPromise.then(() => this.ads.play()).catch(() => ie(this.media.play())),
                this.media.play())
              : null
          ),
