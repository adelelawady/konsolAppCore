...
function _defineProperty$1(e, t, i) {
  return (
    (t = _toPropertyKey(t)) in e ? Object.defineProperty(e, t, { value: i, enumerable: !0, configurable: !0, writable: !0 }) : (e[t] = i), e
  );
}
          ...
          if ('undefined' === t);
            ...
            if ('[object Array]' === Object.prototype.toString.call(e))
              for (var s = 0; s < e.length; s++) {
                var r = e[s];
                if ('[object Array]' !== Object.prototype.toString.call(r) && 2 === r.length)
                  throw new TypeError('Expected [string, any] as entry at index ' + s + " of URLSearchParams's input");
                this.append(r[0], r[1]);
              }
    ...
    'function' != typeof r._fromString &&
      Object.defineProperty(r, '_fromString', {
        ...
        value: function (e) {
          ...
          var s,
            r = (e = e.replace(/^\?/, '')).split('&');
          for (i = 0; i < r.length; i++) (s = r[i].split('=')), this.append(n(s[0]), s.length > 1 ? n(s[1]) : '');
        },
      });
          ...
          var t = e.URL,
            i = function (t, i) {
              ...
              if (i && (void 0 === e.location || i !== e.location.href)) {
                (i = i.toLowerCase()),
                  ((s = (n = document.implementation.createHTMLDocument('')).createElement('base')).href = i),
              ...
              (r.href = t), s && (n.body.appendChild(r), (r.href = r.href));
              var a = n.createElement('input');
              if (((a.type = 'url'), (a.value = t), ':' === r.protocol || !/:/.test(r.href) || (!a.checkValidity() && !i)))
...
var RangeTouch = (function () {
  function e(t, i) {
    _classCallCheck(this, e),
      is$1.element(t) ? (this.element = t) : is$1.string(t) && (this.element = document.querySelector(t)),
      is$1.element(this.element) &&
        is$1.empty(this.element.rangeTouch) &&
        ((this.config = _objectSpread2({}, defaults$1, {}, i)), this.init());
  }
  return (
    _createClass(
      e,
      [
        ...
        },
        {
          ...
          value: function (t) {
            ...
            return (
              0 > (i = (100 / l.width) * (n.clientX - l.left)) ? (i = 0) : 100 < i && (i = 100),
        ...
        },
        {
          ...
          value: function (t) {
            e.enabled &&
              is$1.event(t) &&
              !t.target.disabled &&
              (t.preventDefault(), (t.target.value = this.get(t)), trigger(t.target, 'touchend' === t.type ? 'change' : 'input'));
          },
        },
      ],
      [
          ...
          value: function (t) {
            ...
            if (
              (is$1.empty(t) || is$1.string(t)
                ? (s = Array.from(document.querySelectorAll(is$1.string(t) ? t : 'input[type="range"]')))
                : is$1.element(t)
                ? (s = [t])
                : is$1.nodeList(t)
                ? (s = Array.from(t))
...
const getConstructor = e => (null != e ? e.constructor : null),
  ...
  isElement = e =>
    null !== e && 'object' == typeof e && 1 === e.nodeType && 'object' == typeof e.style && 'object' == typeof e.ownerDocument,
  isEmpty = e =>
    isNullOrUndefined(e) || ((isString(e) || isArray(e) || isNodeList(e)) && !e.length) || (isObject(e) && !Object.keys(e).length),
  isUrl = e => {
...
var browser = { isIE: isIE, isEdge: isEdge, isWebKit: isWebKit, isIPhone: isIPhone, isIPadOS: isIPadOS, isIos: isIos };
...
function extend(e = {}, ...t) {
  ...
  return is.object(i)
    ? (Object.keys(i).forEach(t => {
        is.object(i[t])
          ? (Object.keys(e).includes(t) || Object.assign(e, { [t]: {} }), extend(e[t], i[t]))
...
function getAspectRatio(e) {
  ...
  if (
    ...
    null === i && !is.empty(this.embed) && is.array(this.embed.ratio) && ({ ratio: i } = this.embed),
    null === i && this.isHTML5)
  ) {
...
function setAspectRatio(e) {
  ...
  const [s, n] = reduceAspectRatio(i),
    r = (100 / s) * n;
  if (
    (supportsCSS(`aspect-ratio: ${s}/${n}`) ? (t.style.aspectRatio = `${s}/${n}`) : (t.style.paddingBottom = `${r}%`),
...
const controls = {
  ...
  createButton(e, t) {
    ...
    switch (
      ...
      Object.keys(i).includes('class')
        ? i.class.split(' ').some(e => e === this.config.classNames.control) ||
          extend(i, { class: `${i.class} ${this.config.classNames.control}` })
    ...
    return (
      n.toggle
        ? (r.appendChild(controls.createIcon.call(this, n.iconPressed, { class: 'icon--pressed' })),
          r.appendChild(controls.createIcon.call(this, n.icon, { class: 'icon--not-pressed' })),
          r.appendChild(controls.createLabel.call(this, n.labelPressed, { class: 'label--pressed' })),
          r.appendChild(controls.createLabel.call(this, n.label, { class: 'label--not-pressed' })))
        : (r.appendChild(controls.createIcon.call(this, n.icon)), r.appendChild(controls.createLabel.call(this, n.label))),
      extend(i, getAttributesFromSelector(this.config.selectors.buttons[s], i)),
      setAttributes(r, i),
      'play' === s
        ? (is.array(this.elements.buttons[s]) || (this.elements.buttons[s] = []), this.elements.buttons[s].push(r))
  ...
  bindMenuItemShortcuts(e, t) {
    on.call(
      ...
      i => {
        ...
        if (!s && [' ', 'ArrowRight'].includes(i.key)) controls.showMenuPanel.call(this, t, !0);
        else {
          let t;
          ' ' !== i.key &&
            ('ArrowDown' === i.key || (s && 'ArrowRight' === i.key)
              ? ((t = e.nextElementSibling), is.element(t) || (t = e.parentNode.firstElementChild))
              : ((t = e.previousElementSibling), is.element(t) || (t = e.parentNode.lastElementChild)),
            setFocus.call(this, t, !0));
        }
      },
      !1
    ),
      on.call(this, e, 'keyup', e => {
        ...
        set(e) {
          e &&
            Array.from(o.parentNode.children)
              .filter(e => matches(e, '[role="menuitemradio"]'))
  ...
  updateVolume() {
    this.supported.ui &&
      (is.element(this.elements.inputs.volume) && controls.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
      is.element(this.elements.buttons.mute) && (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume));
  },
  setRange(e, t = 0) {
      ...
      switch (e.type) {
        ...
        case 'seeked':
          (t = getPercentage(this.currentTime, this.duration)),
            'timeupdate' === e.type && controls.setRange.call(this, this.elements.inputs.seek, t);
          break;
        case 'playing':
        case 'progress':
  ...
  updateSeekTooltip(e) {
    ...
    c && s.insertAdjacentHTML('afterbegin', `${c.label}<br>`),
      (s.style.left = `${a}%`),
      is.event(e) && ['mouseenter', 'mouseleave'].includes(e.type) && r('mouseenter' === e.type);
  },
  timeUpdate(e) {
    const t = !is.element(this.elements.display.duration) && this.config.invertTime;
    controls.updateTimeDisplay.call(this, this.elements.display.currentTime, t ? this.duration - this.currentTime : this.currentTime, t),
      (e && 'timeupdate' === e.type && this.media.seeking) || controls.updateProgress.call(this, e);
  },
  durationUpdate() {
    ...
    !e &&
      ...
      e && controls.updateTimeDisplay.call(this, this.elements.display.duration, this.duration),
  ...
  setQualityMenu(e) {
    ...
    this.options.quality
      ...
      .forEach(e => {
        controls.createMenuItem.call(this, { value: e, list: i, type: t, title: controls.getLabel.call(this, 'quality', e), badge: n(e) });
      }),
  ...
  setCaptionsMenu() {
    ...
    n.unshift({ value: -1, checked: !this.captions.toggled, title: i18n.get('disabled', this.config), list: t, type: 'language' }),
  ...
  toggleMenu(e) {
    ...
    i.setAttribute('aria-expanded', n),
      toggleHidden(t, !n),
      toggleClass(this.elements.container, this.config.classNames.menu.open, n),
      n && is.keyboardEvent(e) ? controls.focusFirstMenuItem.call(this, null, !0) : n || s || setFocus.call(this, i, is.keyboardEvent(e));
  },
  getMenuSize(e) {
      ...
      const e = controls.getMenuSize.call(this, i),
        t = e => {
          e.target === s &&
            ...
            ((s.style.width = ''), (s.style.height = ''), off.call(this, s, transitionEndEvent, t));
        };
  ...
  create(e) {
    ...
    return (
      dedupe(is.array(this.config.controls) ? this.config.controls : []).forEach(a => {
        if (
          ...
          'fast-forward' === a && c.appendChild(i.call(this, 'fast-forward', u)),
          'progress' === a)
        ) {
        ...
        if (
          ('current-time' === a && c.appendChild(r.call(this, 'currentTime', u)),
          'duration' === a && c.appendChild(r.call(this, 'duration', u)),
          'mute' === a || 'volume' === a)
        ) {
          let { volume: t } = this.elements;
          if (
            ((is.element(t) && c.contains(t)) ||
              ((t = createElement('div', extend({}, u, { class: `${u.class} plyr__volume`.trim() }))),
              (this.elements.volume = t),
              c.appendChild(t)),
            'mute' === a && t.appendChild(i.call(this, 'mute')),
            'volume' === a && !browser.isIos && !browser.isIPadOS)
          ) {
        ...
        if (('captions' === a && c.appendChild(i.call(this, 'captions', u)), 'settings' === a && !is.empty(this.config.settings))) {
          ...
          const n = createElement('div', { class: 'plyr__menu__container', id: `plyr-settings-${e.id}`, hidden: '' }),
            r = createElement('div'),
            a = createElement('div', { id: `plyr-settings-${e.id}-home` }),
          ...
          a.appendChild(o),
            ...
            this.config.settings.forEach(i => {
              ...
              const c = createElement('div', { id: `plyr-settings-${e.id}-${i}`, hidden: '' }),
                u = createElement('button', {
                  type: 'button',
                  class: `${this.config.classNames.control} ${this.config.classNames.control}--back`,
                });
              u.appendChild(createElement('span', { 'aria-hidden': !0 }, i18n.get(i, this.config))),
                u.appendChild(createElement('span', { class: this.config.classNames.hidden }, i18n.get('menuBack', this.config))),
                on.call(
                  this,
                  c,
                  'keydown',
        ...
        if (
          ('pip' === a && support.pip && c.appendChild(i.call(this, 'pip', u)),
          'airplay' === a && support.airplay && c.appendChild(i.call(this, 'airplay', u)),
          'download' === a)
        ) {
          const e = extend({}, u, { element: 'a', href: this.download, target: '_blank' });
          this.isHTML5 && (e.download = '');
          const { download: t } = this.config.urls;
          !is.url(t) && this.isEmbed && extend(e, { icon: `logo-${this.provider}`, label: this.provider }),
  ...
  inject() {
    ...
    let i = !0;
    is.function(this.config.controls) && (this.config.controls = this.config.controls.call(this, t)),
    ...
    i &&
      ...
      is.string(this.config.selectors.controls.container) && (s = document.querySelector(this.config.selectors.controls.container)),
      is.element(s) || (s = this.elements.container);
    if (
      (s[is.element(e) ? 'insertAdjacentElement' : 'insertAdjacentHTML']('afterbegin', e),
  ...
  setMarkers() {
    ...
    i.forEach(e => {
      const t = createElement('span', { class: this.config.classNames.marker }, ''),
      ...
      s.appendChild(n),
      this.config.tooltips.seek || ((r = createElement('span', { class: this.config.classNames.tooltip }, '')), s.appendChild(r)),
...
const captions = {
    setup() {
      ...
      if (
        (is.boolean(i) || ({ active: i } = this.config.captions),
        ...
        e
          ...
          .forEach(e => {
            this.debug.log('Track added', e),
              ...
              on.call(this, e, 'cuechange', () => captions.updateCues.call(this));
          }),
        ((r && this.language !== i) || !e.includes(n)) && (captions.setLanguage.call(this, i), captions.toggle.call(this, t && r)),
        this.elements && toggleClass(this.elements.container, this.config.classNames.captions.enabled, !is.empty(e)),
        is.array(this.config.controls) &&
          this.config.controls.includes('settings') &&
          this.config.settings.includes('captions') &&
          controls.setCaptionsMenu.call(this);
    ...
    toggle(e, t = !0) {
      ...
      if (n !== i) {
        ...
        this.elements.buttons.captions && (this.elements.buttons.captions.pressed = n),
          ...
          triggerEvent.call(this, this.media, n ? 'captionsenabled' : 'captionsdisabled');
      }
      setTimeout(() => {
    ...
    getLabel(e) {
      let t = e;
      return (
        !is.track(t) && support.textTracks && this.captions.toggled && (t = captions.getCurrentTrack.call(this)),
        is.track(t)
          ? is.empty(t.label)
            ? is.empty(t.language)
...
class Fullscreen {
    ...
    _defineProperty$1(this, 'onChange', () => {
      ...
      _defineProperty$1(this, 'toggleFallback', (e = !1) => {
        if (
          ...
          toggleClass(this.target, this.player.config.classNames.fullscreen.fallback, e),
          browser.isIos)
        ) {
      ...
      _defineProperty$1(this, 'update', () => {
        if (this.supported) {
          let e;
          (e = this.forceFallback ? 'Fallback (forced)' : Fullscreen.nativeSupported ? 'Native' : 'Fallback'),
      ...
      (this.player.elements.fullscreen =
        e.config.fullscreen.container && closest$1(this.player.elements.container, e.config.fullscreen.container)),
      on.call(this.player, document, 'ms' === this.prefix ? 'MSFullscreenChange' : `${this.prefix}fullscreenchange`, () => {
        this.onChange();
      }),
      on.call(this.player, this.player.elements.container, 'dblclick', e => {
        (is.element(this.player.elements.controls) && this.player.elements.controls.contains(e.target)) ||
          this.player.listeners.proxy(e, this.toggle, 'fullscreen');
      }),
      on.call(this, this.player.elements.container, 'keydown', e => this.trapFocus(e)),
      this.update();
  }
  ...
  static get prefix() {
    ...
    return (
      ['webkit', 'moz', 'ms'].some(
        t => !(!is.function(document[`${t}ExitFullscreen`]) && !is.function(document[`${t}CancelFullScreen`])) && ((e = t), !0)
      ),
      e
    );
  }
...
const ui = {
  ...
  build() {
    if ((this.listeners.media(), !this.supported.ui))
      return this.debug.warn(`Basic support only for ${this.provider} ${this.type}`), void ui.toggleNativeControls.call(this, !0);
  ...
  setTitle() {
    ...
    if (
      (is.string(this.config.title) && !is.empty(this.config.title) && (e += `, ${this.config.title}`),
...
class Listeners {
  constructor(e) {
    _defineProperty$1(this, 'firstTouch', () => {
      ...
      _defineProperty$1(this, 'global', (e = !0) => {
        const { player: t } = this;
        t.config.keyboard.global && toggleListener.call(t, window, 'keydown keyup', this.handleKey, e, !1),
          toggleListener.call(t, document.body, 'click', this.toggleMenu, e),
          once.call(t, document.body, 'touchstart', this.firstTouch);
      }),
      _defineProperty$1(this, 'container', () => {
        const { player: e } = this,
          { config: t, elements: i, timers: s } = e;
        !t.keyboard.global && t.keyboard.focused && on.call(e, i.container, 'keydown keyup', this.handleKey, !1),
          on.call(e, i.container, 'mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen', t => {
            const { controls: n } = i;
            n && 'enterfullscreen' === t.type && ((n.pressed = !1), (n.hover = !1));
            let r = 0;
            ['touchstart', 'touchmove', 'mousemove'].includes(t.type) && (ui.toggleControls.call(e, !0), (r = e.touch ? 3e3 : 2e3)),
              clearTimeout(s.controls),
              (s.controls = setTimeout(() => ui.toggleControls.call(e, !1), r));
          });
        const n = () => {
            ...
            if (!s)
              return void (a ? ((t.style.width = null), (t.style.height = null)) : ((t.style.maxWidth = null), (t.style.margin = null)));
            const [o, l] = getViewportSize(),
              c = o / l > n / r;
            a
              ? ((t.style.width = c ? 'auto' : '100%'), (t.style.height = c ? '100%' : 'auto'))
              : ((t.style.maxWidth = c ? (l / r) * n + 'px' : null), (t.style.margin = c ? '0 auto' : null));
          },
          r = () => {
      ...
      _defineProperty$1(this, 'media', () => {
        const { player: e } = this,
          { elements: t } = e;
        if (
          (on.call(e, e.media, 'timeupdate seeking seeked', t => controls.timeUpdate.call(e, t)),
          on.call(e, e.media, 'durationchange loadeddata loadedmetadata', t => controls.durationUpdate.call(e, t)),
          on.call(e, e.media, 'ended', () => {
            e.isHTML5 && e.isVideo && e.config.resetOnEnd && (e.restart(), e.pause());
          }),
          on.call(e, e.media, 'progress playing seeking seeked', t => controls.updateProgress.call(e, t)),
          on.call(e, e.media, 'volumechange', t => controls.updateVolume.call(e, t)),
          on.call(e, e.media, 'playing play pause ended emptied timeupdate', t => ui.checkPlaying.call(e, t)),
          on.call(e, e.media, 'waiting canplay seeked playing', t => ui.checkLoading.call(e, t)),
        ...
        e.supported.ui &&
          ...
          on.call(e, e.media, 'volumechange', () => {
      ...
      _defineProperty$1(this, 'controls', () => {
          ...
          this.bind(
            ...
            t => {
              [' ', 'Enter'].includes(t.key) &&
                ('Enter' !== t.key
                  ? (t.preventDefault(), t.stopPropagation(), controls.toggleMenu.call(e, t))
        ...
        this.bind(
          ...
          this.bind(t.progress, 'mouseenter mouseleave mousemove', t => controls.updateSeekTooltip.call(e, t)),
          ...
          browser.isWebKit &&
            Array.from(getElements.call(e, 'input[type="range"]')).forEach(t => {
  ...
  handleKey(e) {
    const { player: t } = this,
      { elements: i } = t,
      { key: s, type: n, altKey: r, ctrlKey: a, metaKey: o, shiftKey: l } = e,
      c = 'keydown' === n,
      u = c && s === this.lastKey;
    if (r || a || o || l) return;
    if (!s) return;
...
function assurePlaybackState$1(e) {
  e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
    this.media.paused === e && ((this.media.paused = !e), triggerEvent.call(this, this.media, e ? 'play' : 'pause'));
}
const vimeo = {
  setup() {
    const e = this;
  ...
  ready() {
    ...
    let r = e.media.getAttribute('src'),
      a = '';
    is.empty(r)
      ? ((r = e.media.getAttribute(e.config.attributes.embed.id)), (a = e.media.getAttribute(e.config.attributes.embed.hash)))
      : (a = parseHash(r));
    const o = a ? { h: a } : {};
    ...
    const l = buildUrlParams({
      ...
      h = format(e.config.urls.vimeo.iframe, c, l);
    if (
    ...
    t.customControls ||
      fetch(format(e.config.urls.vimeo.api, h)).then(t => {
      ...
      (e.media.play = () => (assurePlaybackState$1.call(e, !0), e.embed.play())),
      (e.media.pause = () => (assurePlaybackState$1.call(e, !1), e.embed.pause())),
      (e.media.stop = () => {
    ...
    Object.defineProperty(e.media, 'playbackRate', {
      ...
      set(t) {
        e.embed
          .setPlaybackRate(t)
          .then(() => {
            (p = t), triggerEvent.call(e, e.media, 'ratechange');
          })
          .catch(() => {
            e.options.speed = [1];
          });
    ...
    Object.defineProperty(e.media, 'volume', {
      ...
      set(t) {
        e.embed.setVolume(t).then(() => {
          (m = t), triggerEvent.call(e, e.media, 'volumechange');
        });
      },
    });
    ...
    Object.defineProperty(e.media, 'loop', {
      ...
      e.embed.getCurrentTime().then(t => {
        (d = t), triggerEvent.call(e, e.media, 'timeupdate');
      }),
      ...
      e.embed.on('timeupdate', t => {
        (e.media.seeking = !1), (d = t.seconds), triggerEvent.call(e, e.media, 'timeupdate');
      }),
      e.embed.on('progress', t => {
        (e.media.buffered = t.percent),
          triggerEvent.call(e, e.media, 'progress'),
          1 === parseInt(t.percent, 10) && triggerEvent.call(e, e.media, 'canplaythrough'),
          e.embed.getDuration().then(t => {
...
const youtube = {
    setup() {
      if ((toggleClass(this.elements.wrapper, this.config.classNames.embed, !0), is.object(window.YT) && is.function(window.YT.Player)))
    ...
    ready() {
      ...
      if (((e.media = replaceElement(r, e.media)), t.customControls)) {
        ...
        loadImage(t('maxres'), 121)
          .catch(() => loadImage(t('sd'), 121))
          .catch(() => loadImage(t('hq')))
          .then(t => ui.setPoster.call(e, t.src))
          .then(t => {
      ...
      e.embed = new window.YT.Player(e.media, {
        ...
        events: {
            ...
            (e.options.speed = o.filter(t => e.config.speed.options.includes(t))),
              ...
              (e.timers.buffering = setInterval(() => {
                (e.media.buffered = s.getVideoLoadedFraction()),
                  (null === e.media.lastBuffered || e.media.lastBuffered < e.media.buffered) && triggerEvent.call(e, e.media, 'progress'),
                  (e.media.lastBuffered = e.media.buffered),
                  1 === e.media.buffered && (clearInterval(e.timers.buffering), triggerEvent.call(e, e.media, 'canplaythrough'));
              }, 200)),
          ...
          onStateChange(i) {
            ...
            switch (
              (e.media.seeking && [1, 2].includes(i.data) && ((e.media.seeking = !1), triggerEvent.call(e, e.media, 'seeked')), i.data)
            ) {
              case -1:
                triggerEvent.call(e, e.media, 'timeupdate'),
                  (e.media.buffered = s.getVideoLoadedFraction()),
              ...
              case 1:
                t.customControls && !e.config.autoplay && e.media.paused && !e.embed.hasPlayed
                  ...
                  : (assurePlaybackState.call(e, !0),
                    ...
                    e.media.duration !== s.getDuration() &&
                      ((e.media.duration = s.getDuration()), triggerEvent.call(e, e.media, 'durationchange')));
                break;
              case 2:
    ...
    setup() {
      this.media
        ? (toggleClass(this.elements.container, this.config.classNames.type.replace('{0}', this.type), !0),
          ...
          this.isHTML5 ? html5.setup.call(this) : this.isYouTube ? youtube.setup.call(this) : this.isVimeo && vimeo.setup.call(this))
...
class Ads {
  constructor(e) {
    _defineProperty$1(this, 'load', () => {
      ...
      _defineProperty$1(this, 'on', (e, t) => (is.array(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this)),
      _defineProperty$1(this, 'startSafetyTimer', (e, t) => {
...
const parseVtt = e => {
  ...
  fitRatio = (e, t) => {
    const i = {};
    return (
      e > t.width / t.height ? ((i.width = t.width), (i.height = (1 / e) * t.width)) : ((i.height = t.height), (i.width = e * t.height)), i
    );
  };
  ...
  constructor(e) {
    _defineProperty$1(this, 'load', () => {
      ...
      _defineProperty$1(this, 'startScrubbing', e => {
        (is.nullOrUndefined(e.button) || !1 === e.button || 0 === e.button) &&
          ((this.mouseDown = !0),
      ...
      _defineProperty$1(this, 'render', () => {
        ...
        (this.elements.thumb.time = createElement('span', {}, '00:00')),
          ...
          is.element(this.player.elements.progress) && this.player.elements.progress.appendChild(this.elements.thumb.container),
        ...
        this.destroy.call(
          ...
          () => {
            ...
            const { sources: t, type: i } = e,
              [{ provider: s = providers.html5, src: n }] = t,
              r = 'html5' === s ? i : 'div',
              a = 'html5' === s ? {} : { src: n };
            Object.assign(this, {
              provider: s,
              ...
              this.isHTML5 && Object.keys(e).includes('tracks') && source.insertElements.call(this, 'track', e.tracks),
...
class Plyr {
  constructor(e, t) {
    if (
      ...
      _defineProperty$1(this, 'pause', () => (this.playing && is.function(this.media.pause) ? this.media.pause() : null)),
      _defineProperty$1(this, 'togglePlay', e => ((is.boolean(e) ? e : !this.playing) ? this.play() : this.pause())),
      ...
      _defineProperty$1(this, 'destroy', (e, t = !1) => {
          ...
          (document.body.style.overflow = ''),
            ...
            t
              ...
              : (unbindListeners.call(this),
                ...
                is.function(e) && e.call(this.elements.original),
                (this.ready = !1),
                setTimeout(() => {
        ...
        this.stop(),
          ...
          this.isHTML5
            ? (ui.toggleNativeControls.call(this, !0), i())
            : this.isYouTube
            ? (clearInterval(this.timers.buffering),
              clearInterval(this.timers.playing),
              null !== this.embed && is.function(this.embed.destroy) && this.embed.destroy(),
              i())
            : this.isVimeo && (null !== this.embed && this.embed.unload().then(i), setTimeout(i, 200));
      }),
      _defineProperty$1(this, 'supports', e => support.mime.call(this, e)),
      (this.timers = {}),
      (this.ready = !1),
      (this.loading = !1),
      (this.failed = !1),
      ...
      ((window.jQuery && this.media instanceof jQuery) || is.nodeList(this.media) || is.array(this.media)) && (this.media = this.media[0]),
      (this.config = extend(
        {},
        defaults,
        Plyr.defaults,
        ...
        if (((n = this.media.querySelector('iframe')), is.element(n))) {
          if (
            ...
            e.includes(r.searchParams.get('autoplay')) && (this.config.autoplay = !0),
              ...
              this.isYouTube
                ? ((this.config.playsinline = e.includes(r.searchParams.get('playsinline'))),
      ...
      this.supported.api
        ? ((this.eventListeners = []),
          ...
          is.element(this.elements.container) ||
            ((this.elements.container = createElement('div')), wrap(this.media, this.elements.container)),
          ui.migrateStyles.call(this),
          ui.addStyleHook.call(this),
          media.setup.call(this),
          this.config.debug &&
            on.call(this, this.elements.container, this.config.events.join(' '), e => {
  ...
  set volume(e) {
    ...
    is.string(t) && (t = Number(t)),
      ...
      is.number(t) || ({ volume: t } = this.config),
      t > 1 && (t = 1),
      t < 0 && (t = 0),
  ...
  set ratio(e) {
    this.isVideo
      ? is.string(e) && validateAspectRatio(e)
        ? ((this.config.ratio = reduceAspectRatio(e)), setAspectRatio.call(this))
  ...
  set pip(e) {
    ...
    is.function(this.media.webkitSetPresentationMode) && this.media.webkitSetPresentationMode(t ? pip.active : pip.inactive),
  ...
  static setup(e, t = {}) {
    ...
    return (
      ...
      is.empty(i) ? null : i.map(e => new Plyr(e, t))
    );
  }
}
