  ...
  (function (e, t) {
            ...
            (function () {
              var t = e.URL,
                i = function (t, i) {
                  ...
                  if (((r.type = 'url'), (r.value = t), ':' === a.protocol || !/:/.test(a.href) || (!r.checkValidity() && !i)))
    ...
    const K = {
      ...
      Y = {
        ...
        pip: !(
          x.isIPhone ||
          (!A.function(O('video').webkitSetPresentationMode) && (!document.pictureInPictureEnabled || O('video').disablePictureInPicture))
        ),
    ...
    function ue(e) {
      ...
      if (
        ...
        null === i && !A.empty(this.embed) && A.array(this.embed.ratio) && ({ ratio: i } = this.embed),
        null === i && this.isHTML5)
      ) {
    ...
    function he(e) {
      ...
      const [s, n] = ce(i),
        a = (100 / s) * n;
      if (
        (re(`aspect-ratio: ${s}/${n}`) ? (t.style.aspectRatio = `${s}/${n}`) : (t.style.paddingBottom = `${a}%`),
    ...
    const Me = {
      ...
      createIcon(e, t) {
        ...
        const r = document.createElementNS(i, 'use'),
          o = `${n}-${e}`;
        return (
          'href' in r && r.setAttributeNS('http://www.w3.org/1999/xlink', 'href', o),
      ...
      createButton(e, t) {
        ...
        return (
          ...
          I(a, i),
          'play' === s
            ? (A.array(this.elements.buttons[s]) || (this.elements.buttons[s] = []), this.elements.buttons[s].push(a))
      ...
      createProgress(e, t) {
        const i = O(
          'progress',
          N(q(this.config.selectors.display[e]), { min: 0, max: 100, value: 0, role: 'progressbar', 'aria-hidden': !0 }, t)
        );
        if ('volume' !== e) {
      ...
      updateSeekTooltip(e) {
        ...
        c && s.insertAdjacentHTML('afterbegin', `${c.label}<br>`),
          (s.style.left = `${r}%`),
          A.event(e) && ['mouseenter', 'mouseleave'].includes(e.type) && a('mouseenter' === e.type);
      },
      timeUpdate(e) {
        const t = !A.element(this.elements.display.duration) && this.config.invertTime;
        Me.updateTimeDisplay.call(this, this.elements.display.currentTime, t ? this.duration - this.currentTime : this.currentTime, t),
          (e && 'timeupdate' === e.type && this.media.seeking) || Me.updateProgress.call(this, e);
      },
      durationUpdate() {
        ...
        !e &&
          ...
          this.paused &&
          Me.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
      ...
      setCaptionsMenu() {
        ...
        n.unshift({ value: -1, checked: !this.captions.toggled, title: we.get('disabled', this.config), list: t, type: 'language' }),
          ...
          const e = Me.getMenuSize.call(this, i),
            t = e => {
              e.target === s &&
                ...
                ((s.style.width = ''), (s.style.height = ''), G.call(this, s, P, t));
            };
      ...
      create(e) {
        ...
        return (
          ne(A.array(this.config.controls) ? this.config.controls : []).forEach(r => {
            ...
            if (
              ('current-time' === r && c.appendChild(a.call(this, 'currentTime', u)),
              ...
              if (
                ((A.element(t) && c.contains(t)) ||
                  ((t = O('div', N({}, u, { class: `${u.class} plyr__volume`.trim() }))), (this.elements.volume = t), c.appendChild(t)),
            ...
            if (
              ...
              'airplay' === r && Y.airplay && c.appendChild(i.call(this, 'airplay', u)),
              'download' === r)
            ) {
              const e = N({}, u, { element: 'a', href: this.download, target: '_blank' });
              this.isHTML5 && (e.download = '');
              const { download: t } = this.config.urls;
              !A.url(t) && this.isEmbed && N(e, { icon: `logo-${this.provider}`, label: this.provider }),
      ...
      inject() {
        ...
        if (
          (s[A.element(e) ? 'insertAdjacentElement' : 'insertAdjacentHTML']('afterbegin', e),
    ...
    class He {
      constructor(e) {
        t(this, 'onChange', () => {
          ...
          t(this, 'exit', () => {
            if (this.supported)
              if (x.isIos && this.player.config.fullscreen.iosNative)
                this.player.isVimeo ? this.player.embed.exitFullscreen() : this.target.webkitEnterFullscreen(), se(this.player.play());
          ...
          J.call(this.player, this.player.elements.container, 'dblclick', e => {
            (A.element(this.player.elements.controls) && this.player.elements.controls.contains(e.target)) ||
      ...
      static get prefix() {
        ...
        return (
          ['webkit', 'moz', 'ms'].some(
            t => !(!A.function(document[`${t}ExitFullscreen`]) && !A.function(document[`${t}CancelFullScreen`])) && ((e = t), !0)
          ),
          e
        );
      }
    ...
    const Ue = {
      addStyleHook() {
        F(this.elements.container, this.config.selectors.container.replace('.', ''), !0),
          F(this.elements.container, this.config.classNames.uiSupported, this.supported.ui);
      },
      ...
      build() {
        if ((this.listeners.media(), !this.supported.ui))
          return this.debug.warn(`Basic support only for ${this.provider} ${this.type}`), void Ue.toggleNativeControls.call(this, !0);
    ...
    class Ve {
      constructor(e) {
        t(this, 'firstTouch', () => {
          ...
          t(this, 'global', (e = !0) => {
            const { player: t } = this;
            t.config.keyboard.global && X.call(t, window, 'keydown keyup', this.handleKey, e, !1),
          ...
          t(this, 'container', () => {
            ...
            const n = () => {
                ...
                r
                  ...
                  : ((t.style.maxWidth = c ? (l / a) * n + 'px' : null), (t.style.margin = c ? '0 auto' : null));
              },
              a = () => {
              ...
              this.bind(
                ...
                t => {
                  [' ', 'Enter'].includes(t.key) &&
                    ('Enter' !== t.key
                      ? (t.preventDefault(), t.stopPropagation(), Me.toggleMenu.call(e, t))
          ...
          (n = n || 0),
            /(^css!|\.css$)/.test(d)
              ? (((r = l.createElement('link')).rel = 'stylesheet'),
                (r.href = m),
                (a = 'hideFocus' in r) && r.relList && ((a = 0), (r.rel = 'preload'), (r.as = 'style')))
    ...
    function ze(e) {
      e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
        this.media.paused === e && ((this.media.paused = !e), ee.call(this, this.media, e ? 'play' : 'pause'));
    }
    const Ke = {
      setup() {
        const e = this;
    ...
    const Xe = {
        setup() {
          if ((F(this.elements.wrapper, this.config.classNames.embed, !0), A.object(window.YT) && A.function(window.YT.Player)))
            Xe.ready.call(this);
          else {
                  ...
                  case 1:
                    t.customControls && !e.config.autoplay && e.media.paused && !e.embed.hasPlayed
                      ...
                      : (Ye.call(e, !0),
                        ...
                        e.media.duration !== s.getDuration() &&
                          ((e.media.duration = s.getDuration()), ee.call(e, e.media, 'durationchange')));
                    break;
                  case 2:
            ...
            this.destroy.call(
              ...
              () => {
                (this.options.quality = []),
                  j(this.media),
                  (this.media = null),
                  A.element(this.elements.container) && this.elements.container.removeAttribute('class');
      ...
      constructor(e, i) {
        if (
          (t(this, 'play', () =>
            A.function(this.media.play)
              ? (this.ads && this.ads.enabled && this.ads.managerPromise.then(() => this.ads.play()).catch(() => se(this.media.play())),
                this.media.play())
              : null
          ),
            ...
            this.stop(),
              ...
              this.isHTML5
                ...
                ? (clearInterval(this.timers.buffering),
                  ...
                  null !== this.embed && A.function(this.embed.destroy) && this.embed.destroy(),
                  i())
          ...
          ((window.jQuery && this.media instanceof jQuery) || A.nodeList(this.media) || A.array(this.media)) &&
        ...
        switch (n) {
          case 'div':
            ...
            if (A.empty(this.provider) || !Object.values($e).includes(this.provider))
