    ...
    var n = (function () {
      ...
      return (
            ...
            if (o.length) {
              ...
              if (g.test(e)) {
                ...
                r.month
                  ...
                  : r.longMonth && (b = t.longMonths(n).indexOf(v[r.longMonth]));
        ...
        (t.prototype.getWeek = function (t) {
          ...
          var n = e.getTime();
          return (
            e.setMonth(0, 1), e.getDay() !== t && e.setMonth(0, 1 + ((4 - e.getDay() + 7) % 7)), 1 + Math.ceil((n - e.getTime()) / 6048e5)
          );
        }),
        ...
        return (
            ...
            if (this.options.element instanceof HTMLInputElement) {
              ...
              if (this.options.singleMode && t) this.options.element.value = t.format(this.options.format, this.options.lang);
                ...
                this.options.elementEnd instanceof HTMLInputElement
                  ? ((this.options.element.value = i), (this.options.elementEnd.value = n))
                  : (this.options.element.value = '' + i + this.options.delimiter + n);
              }
              t ||
                e ||
                ...
                if (this.isSamePicker(e))
                  if ((this.emit('before:click', e), this.preventClick)) this.preventClick = !1;
                    ...
                    if (e.classList.contains(l.buttonPreviousMonth)) {
                      ...
                      return (
                        this.calendars[n].setMonth(this.calendars[n].getMonth() - o),
          ...
          (e.prototype.onMouseEnter = function (t) {
            ...
            if (this.isDayItem(i) && this.shouldAllowMouseEnter(i)) {
              ...
              if (
                ...
                r
                  ? (n && n.classList.add(l.isFlipped), i.classList.add(l.isFlipped))
                  : (n && n.classList.remove(l.isFlipped), i.classList.remove(l.isFlipped)),
          ...
          (e.prototype.onInput = function (t) {
            ...
            if (
              ...
              var r = i.clone(),
                l = 0;
              (this.options.elementEnd ? i.format(o) === t.target.value : t.target.value.startsWith(i.format(o))) ||
          ...
          (e.prototype.render = function () {
            ...
            (i.className = a.containerMonths),
              a['columns' + this.options.numberOfColumns] &&
                (i.classList.remove(a.columns2, a.columns3, a.columns4), i.classList.add(a['columns' + this.options.numberOfColumns])),
              this.options.splitView && i.classList.add(a.splitView),
              this.options.showWeekNumbers && i.classList.add(a.showWeekNumbers);
            for (
              var n = this.calendars[0].clone(), o = n.getMonth(), s = n.getMonth() + this.options.numberOfMonths, r = 0, l = o;
              l < s;
              l += 1
            ) {
              var c = n.clone();
            ...
            if (this.options.dropdowns.years) {
              ...
              for (d = y; d >= v; d -= 1) {
                ...
                (u.value = String(d)),
                  (u.text = String(d)),
                  (u.disabled =
                    (this.options.minDate && b.isBefore(new r.DateTime(this.options.minDate), 'year')) ||
                    (this.options.maxDate && b.isAfter(new r.DateTime(this.options.maxDate), 'year'))),
        ...
        function e(e) {
          ...
          (i.options = s(s({}, i.options), e)),
            ...
            i.options.highlightedDays.length &&
              (i.options.highlightedDays = a.DateTime.convertArray(i.options.highlightedDays, i.options.highlightedDaysFormat));
          var l = i.parseInput(),
            c = l[0],
            h = l[1];
          i.options.startDate &&
            (i.options.singleMode || i.options.endDate) &&
            (c = new a.DateTime(i.options.startDate, i.options.format, i.options.lang)),
            ...
            i.options.singleMode ||
              (i.options.startDate instanceof a.DateTime && i.options.endDate instanceof a.DateTime) ||
    ...
    function h(t, e, i, n) {
      ...
      if (
        (void 0 === (s = t._events)
          ...
          : (void 0 !== s.newListener && (t.emit('newListener', e, i.listener ? i.listener : i), (s = t._events)), (r = s[e])),
        void 0 === r)
      )
        (r = s[e] = i), ++t._eventsCount;
      else if (
        ('function' == typeof r ? (r = s[e] = n ? [i, r] : [r, i]) : n ? r.unshift(i) : r.push(i),
      ...
      (a.prototype.removeAllListeners = function (t) {
        ...
        if (void 0 === i.removeListener)
          return (
            0 === arguments.length
              ? ((this._events = Object.create(null)), (this._eventsCount = 0))
              : void 0 !== i[t] && (0 == --this._eventsCount ? (this._events = Object.create(null)) : delete i[t]),
            this
          );
    ...
    (s.Litepicker.prototype.show = function (t) {
      ...
      (s.Litepicker.prototype.setDateRange = function (t, e, i) {
        ...
        (this.options.disallowLockDaysInRange
          ...
          : r.dateIsLocked(n, this.options, [n, s]) || r.dateIsLocked(s, this.options, [n, s])) && !i
    ...
    Litepicker.add('keyboardnav', {
      init: function (e) {
        ...
        c.element instanceof HTMLElement &&
          (c.element.addEventListener('mousedown', r.bind(e), !0), c.element.addEventListener('focus', i.bind(e), !0)),
          c.elementEnd instanceof HTMLElement &&
            (c.elementEnd.addEventListener('mousedown', r.bind(e), !0), c.elementEnd.addEventListener('focus', i.bind(e), !0)),
