        ...
        return (
          ...
          (e.prototype.renderMonth = function (t, e) {
            ...
            (k.type = 'button'),
              ...
              l.appendChild(p),
              l.appendChild(k),
              this.options.minDate && i.isSameOrBefore(new r.DateTime(this.options.minDate), 'month') && s.classList.add(a.noPreviousMonth),
            ...
            this.options.showWeekNumbers && I && P.appendChild(this.renderWeekNumber(i));
            for (var x = 0; x < I; x += 1) {
