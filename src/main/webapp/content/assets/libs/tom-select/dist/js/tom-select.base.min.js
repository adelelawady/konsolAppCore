...
!(function (t, e) {
  ...
  class dt extends (function (t) {
    ...
    clearActiveOption() {
      this.activeOption && (N(this.activeOption, 'active'), Q(this.activeOption, { 'aria-selected': null })),
        (this.activeOption = null),
    ...
    removeItem(t = null, e) {
      ...
      (s = K(t)),
        t.remove(),
        t.classList.contains('active') && ((n = i.activeItems.indexOf(t)), i.activeItems.splice(n, 1), N(t, 'active')),
        i.items.splice(s, 1),
        (i.lastQuery = null),
      ...
      if (
        ...
        Q(s, { 'data-value': i }),
          'item' === t
            ...
            : (H(s, n.settings.optionClass), Q(s, { role: 'option', id: e.$id }), (e.$div = s), (n.options[i] = e));
      }
      return s;
    }
    _render(t, e) {
