...
!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(e)
    : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).TomSelect = e());
})(this, function () {
  'use strict';
  function t(t, e) {
    t.split(/\s+/).forEach(t => {
  ...
  const C = t => {
    ...
    k = (t, e, i) => {
      ...
      return t
        ? ((t += ''),
          null == e.regex || -1 === (n = t.search(e.regex)) ? 0 : ((s = e.string.length / t.length), 0 === n && (s += 0.5), s * i))
        : 0;
    },
    L = (t, e) => {
      var i = t[e];
  ...
  class T {
    constructor(t, e) {
      (this.items = void 0), (this.settings = void 0), (this.items = t), (this.settings = e || { diacritics: !0 });
    }
    tokenize(t, e, i) {
      ...
      return (
        ...
        n.forEach(t => {
          ...
          o && (i = t.match(o)) && ((n = i[1]), (t = i[2])),
            t.length > 0 && ((l = this.settings.diacritics ? C(t) || null : r(t)), l && e && (l = '\\b' + l)),
            s.push({ string: t, regex: l ? new RegExp(l, 'iu') : null, field: n });
        }),
        s
      );
    }
    ...
    _getScoreFunction(t) {
      ...
      const l =
        1 === o
          ? function (t, e) {
              const i = s[0].field;
              return k(r(e, i), t, n[i] || 1);
            }
          : function (t, e) {
              var i = 0;
              if (t.field) {
                const s = r(e, t.field);
                !t.regex && s ? (i += 1 / o) : (i += k(s, t, 1));
              } else
                E(n, (s, n) => {
                  i += k(r(e, n), t, s);
                });
    ...
    _getSortFunction(t) {
      ...
      return i.length
        ? function (t, e) {
            var s, n;
            for (let o of i) {
              if (((n = o.field), (s = ('desc' === o.direction ? -1 : 1) * P(r(n, t), r(n, e))))) return s;
            }
            return 0;
          }
        : null;
    ...
    prepareSearch(t, e) {
      ...
      if ((L(s, 'sort'), L(s, 'sort_empty'), s.fields)) {
        ...
        const t = [];
        s.fields.forEach(e => {
          'string' == typeof e && (e = { field: e, weight: 1 }), t.push(e), (i[e.field] = 'weight' in e ? e.weight : 1);
        }),
          (s.fields = t);
      }
      return {
    ...
    search(t, e) {
      ...
      t.length
        ? E(n.items, (t, n) => {
            (i = o(t)), (!1 === e.filter || i > 0) && s.items.push({ score: i, id: n });
          })
        : E(n.items, (t, e) => {
  ...
  const j = (t, e) => {
    ...
    R = t => {
      ...
      return (
        j(t, t => {
          'string' == typeof t && (t = t.trim().split(/[\11\12\14\15\40]/)), Array.isArray(t) && (e = e.concat(t));
        }),
        e.filter(Boolean)
      );
    },
  ...
  const X = t => (null == t ? null : Y(t)),
    ...
    Z = t => (t + '').replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;'),
    tt = (t, e) => {
      var i;
      return function (s, n) {
        var o = this;
    ...
    nt = (t, e) => !!e && !!e[t] && 1 === (e.altKey ? 1 : 0) + (e.ctrlKey ? 1 : 0) + (e.shiftKey ? 1 : 0) + (e.metaKey ? 1 : 0),
    ot = (t, e) => {
  ...
  function at(t, e) {
    ...
    var p,
      ...
      v,
      m,
      y = { placeholder: u, options: [], optgroups: [], items: [], maxItems: null };
    return (
      'select' === d
        ? ((h = y.options),
          (g = {}),
  ...
  class dt extends (function (t) {
    return (
      ...
      class extends t {
        constructor(...t) {
          super(...t), (this.plugins = { names: [], settings: {}, requested: {}, loaded: {} });
        }
        static define(e, i) {
        ...
        initializePlugins(t) {
          ...
          if (Array.isArray(t))
            t.forEach(t => {
              'string' == typeof t ? n.push(t) : ((s.plugins.settings[t.name] = t.options), n.push(t.name));
            });
    ...
    constructor(t, e) {
      ...
      'function' != typeof o &&
        ...
        o instanceof RegExp ? (n.createFilter = t => o.test(t)) : (n.createFilter = t => this.settings.duplicates || !this.options[t])),
      ...
      const r = V('<div>'),
        ...
        c = V('<div role="listbox" tabindex="-1">'),
        d = this.input.getAttribute('class') || '',
        u = n.mode;
      var p;
      if (
        (N(r, n.wrapperClass, d, u),
        N(l, n.controlClass),
        lt(r, l),
        N(a, n.dropdownClass, u),
        n.copyClassesToDropdown && N(a, d),
        N(c, n.dropdownContentClass),
        lt(a, c),
        V(n.dropdownParent || r).appendChild(a),
        $(n.controlInput))
      ) {
        p = V(n.controlInput);
    ...
    setup() {
      ...
      (null === e.maxItems || e.maxItems > 1) && t.is_select_tag && Q(a, { multiple: 'multiple' }),
        ...
        !e.splitOn && e.delimiter && (e.splitOn = new RegExp('\\s*' + r(e.delimiter) + '+\\s*')),
      ...
      st(document, 'mousedown', v),
        ...
        N(a, 'tomselected', 'ts-hidden-accessible'),
    ...
    onKeyDown(t) {
      ...
      if (((e.ignoreHover = !0), e.isLocked)) 9 !== t.keyCode && it(t);
        ...
        switch (t.keyCode) {
          case 65:
            if (nt(U, t) && '' == e.control_input.value) return it(t), void e.selectAll();
            break;
          case 27:
            return e.isOpen && (it(t, !0), e.close()), void e.clearActiveItems();
          case 40:
          ...
          case 13:
            return void (e.canSelect(e.activeOption)
              ...
              : ((e.settings.create && e.createItem()) || (document.activeElement == e.control_input && e.isOpen)) && it(t));
          case 37:
          ...
          case 9:
            return void (
              ...
              (e.canSelect(e.activeOption) && (e.onOptionSelect(t, e.activeOption), it(t)), e.settings.create && e.createItem() && it(t))
            );
          case 8:
          case 46:
    ...
    onFocus(t) {
      ...
      e.ignoreFocus ||
        ...
        i || e.trigger('focus'),
        e.activeItems.length || (e.showInput(), e.refreshOptions(!!e.settings.openOnFocus)),
        e.refreshState());
    }
    onBlur(t) {
      ...
      (e.parentElement && e.parentElement.matches('[data-disabled]')) ||
        (e.classList.contains('create')
          ...
          : void 0 !== (i = e.dataset.value) &&
            ...
            s.addItem(i),
            s.settings.closeAfterSelect && s.close(),
            !s.settings.hideSelected && t.type && /click/.test(t.type) && s.setActiveOption(e)));
    }
    canSelect(t) {
    ...
    loadCallback(t, e) {
      ...
      (i.loading = Math.max(i.loading - 1, 0)),
        ...
        i.loading || H(i.wrapper, i.settings.loadingClass),
        i.trigger('load', t, e);
    }
    preload() {
    ...
    setActiveItem(t, e) {
      ...
      if ('single' !== a.settings.mode) {
        ...
        if ('click' === (i = e && e.type.toLowerCase()) && nt('shiftKey', e) && a.activeItems.length) {
          for (
            l = a.getLastActive(),
              (n = Array.prototype.indexOf.call(a.control.children, l)) > (o = Array.prototype.indexOf.call(a.control.children, t)) &&
                ((r = n), (n = o), (o = r)),
              s = n;
            s <= o;
            s++
          )
            (t = a.control.children[s]), -1 === a.activeItems.indexOf(t) && a.setActiveItemClass(t);
          it(e);
        } else
    ...
    clearActiveOption() {
      this.activeOption && (H(this.activeOption, 'active'), Q(this.activeOption, { 'aria-selected': null })),
        (this.activeOption = null),
    ...
    inputState() {
      ...
      t.control.contains(t.control_input) &&
        ...
        t.activeItems.length > 0 || (!t.isFocused && t.settings.hidePlaceholder && t.items.length > 0)
          ? (t.setTextboxValue(), (t.isInputHidden = !0))
          : (t.settings.hidePlaceholder && t.items.length > 0 && Q(t.control_input, { placeholder: '' }), (t.isInputHidden = !1)),
    ...
    search(t) {
      ...
      if (s.settings.score && 'function' != typeof (i = s.settings.score.call(s, t)))
        throw new Error('Tom Select "score" setting must be a function that returns a function');
      return (
        t !== s.lastQuery
          ? ((s.lastQuery = t), (e = s.sifter.search(t, Object.assign(n, { score: i }))), (s.currentResults = e))
    ...
    refreshOptions(t = !0) {
        ...
        for (
          ...
          void 0 === t && ((t = document.createDocumentFragment()), p.push(o)),
            i > 0 &&
              ...
              H(d, 'active'),
              h.activeOption && h.activeOption.dataset.value == n && c && c.dataset.group === o.toString() && (y = d)),
            t.appendChild(d),
            (u[o] = t);
        }
      }
      ...
      if (
        (h.loading ? w('loading') : h.settings.shouldLoad.call(h, g) ? 0 === m.items.length && w('no_results') : w('not_loading'),
    ...
    updateOption(t, e) {
      ...
      c &&
        ...
        (s = i._render('item', e)),
        c.classList.contains('active') && N(s, 'active'),
        G(c, s)),
        (i.lastQuery = null);
    }
    removeOption(t, e) {
    ...
    removeItem(t = null, e) {
      ...
      (s = K(t)),
        t.remove(),
        t.classList.contains('active') && ((n = i.activeItems.indexOf(t)), i.activeItems.splice(n, 1), H(t, 'active')),
        i.items.splice(s, 1),
        (i.lastQuery = null),
        !i.settings.persist && i.userOptions.hasOwnProperty(o) && i.removeOption(o, e),
    ...
    updateOriginalInput(t = {}) {
      ...
      if (e.is_select_tag) {
        ...
        function o(i, s, o) {
          return (
            i || (i = V('<option value="' + Z(s) + '">' + Z(o) + '</option>')),
        ...
        e.input.querySelectorAll('option:checked').forEach(t => {
          ...
          0 == e.items.length && 'single' == e.settings.mode
            ? o(n, '', '')
            : e.items.forEach(n => {
                if (((i = e.options[n]), (s = i[e.settings.labelField] || ''), t.includes(i.$option))) {
                  o(e.input.querySelector(`option[value="${rt(n)}"]:not(:checked)`), n, s);
    ...
    close(t = !0) {
      var e = this,
        i = e.isOpen;
      t && (e.setTextboxValue(), 'single' === e.settings.mode && e.items.length && e.hideInput()),
        (e.isOpen = !1),
    ...
    destroy() {
      ...
      t.trigger('destroy'),
        ...
        H(t.input, 'tomselected', 'ts-hidden-accessible'),
        t._destroy(),
    ...
    render(t, e) {
      ...
      if (
        ...
        Q(s, { 'data-value': i }),
          'item' === t
            ? (N(s, n.settings.itemClass), Q(s, { 'data-ts-item': '' }))
            : (N(s, n.settings.optionClass), Q(s, { role: 'option', id: e.$id }), (e.$div = s), (n.options[i] = e));
      }
      return s;
    }
    _render(t, e) {
    ...
    hook(t, e, i) {
      ...
      s[e] = function () {
        ...
        return (
          ...
          'instead' === t ? o : ('before' === t && (e = n.apply(s, arguments)), e)
        );
      };
    }
  }
  return (
    dt.define('caret_position', function () {
      var t = this;
      t.hook('instead', 'setCaret', e => {
        'single' !== t.settings.mode && t.control.contains(t.control_input)
        ...
        t.hook('instead', 'moveCaret', e => {
          ...
          if (i) {
            const s = K(i);
            t.setCaret(e > 0 ? s + 1 : s), t.setActiveItem(), H(i, 'last-active');
          } else t.setCaret(t.caretPos + e);
        });
    }),
    dt.define('dropdown_input', function () {
      const t = this;
      (t.settings.shouldOpen = !0),
        t.hook('before', 'setup', () => {
          (t.focus_node = t.control), N(t.control_input, 'dropdown-input');
          ...
          (i.placeholder = t.settings.placeholder || ''), t.control.append(i);
        }),
        t.on('initialize', () => {
          t.control_input.addEventListener('keydown', e => {
            switch (e.keyCode) {
              case 27:
                return t.isOpen && (it(e, !0), t.close()), void t.clearActiveItems();
              case 9:
          ...
          t.hook('instead', 'onBlur', i => {
            if (!i || i.relatedTarget != t.control_input) return e.call(t);
          }),
            st(t.control_input, 'blur', () => t.onBlur()),
            t.hook('before', 'close', () => {
              t.isOpen && t.focus_node.focus({ preventScroll: !0 });
            });
        });
    }),
    dt.define('no_backspace_delete', function () {
      var t = this,
        e = t.deleteSelection;
      this.hook('instead', 'deleteSelection', i => !!t.activeItems.length && e.call(t, i));
    }),
    dt.define('remove_button', function (t) {
      const e = Object.assign({ label: '&times;', title: 'Remove', className: 'remove', append: !0 }, t);
      var i = this;
      if (e.append) {
        var s = '<a href="javascript:void(0)" class="' + e.className + '" tabindex="-1" title="' + Z(e.title) + '">' + e.label + '</a>';
        i.hook('after', 'setupTemplates', () => {
          var t = i.settings.render.item;
          i.settings.render.item = (e, n) => {
            var o = V(t.call(i, e, n)),
              r = V(s);
            return (
              o.appendChild(r),
              st(r, 'mousedown', t => {
              ...
              st(r, 'click', t => {
                it(t, !0), i.isLocked || (i.shouldDelete([o], t) && (i.removeItem(o), i.refreshOptions(!1), i.inputState()));
              }),
              o
            );
          };
    ...
    dt.define('restore_on_backspace', function (t) {
      const e = this,
        i = Object.assign({ text: t => t[e.settings.labelField] }, t);
      e.on('item_remove', function (t) {
        if (e.isFocused && '' === e.control_input.value.trim()) {
          var s = e.options[t];
          s && e.setTextboxValue(i.text.call(e, s));
        }
      });
    }),
    dt
