...
!(function (e, t) {
    ...
    _getSortFunction(e) {
      ...
      return i.length
        ? function (e, t) {
            var s, n;
            for (let o of i) {
              if (((n = o.field), (s = ('desc' === o.direction ? -1 : 1) * P(r(n, e), r(n, t))))) return s;
            }
            return 0;
          }
        : null;
  ...
  const Y = e => (null == e ? null : Z(e)),
    ...
    oe = (e, t) => !!t && !!t[e] && 1 === (t.altKey ? 1 : 0) + (t.ctrlKey ? 1 : 0) + (t.shiftKey ? 1 : 0) + (t.metaKey ? 1 : 0),
    re = (e, t) => {
    ...
    return (
      'select' === d
        ? ((h = y.options),
          ...
          j(e.children, e => {
            var t, i, s;
            'optgroup' === (p = e.tagName.toLowerCase())
              ? (((s = v((t = e)))[a] = s[a] || t.getAttribute('label') || ''),
                (s[c] = s[c] || f++),
                (s[r] = s[r] || t.disabled),
                y.optgroups.push(s),
                (i = s[c]),
  ...
  class ue extends (function (e) {
    ...
    constructor(e, t) {
      ...
      (this.settings = n),
        ...
        (this.inputId = re(s, 'tomselect-' + de)),
      ...
      if (
        ...
        p = V(n.controlInput);
        E(['autocorrect', 'autocapitalize', 'autocomplete'], e => {
          s.getAttribute(e) && G(p, { [e]: s.getAttribute(e) });
        }),
          (p.tabIndex = -1),
          l.appendChild(p),
          (this.focus_node = p);
    ...
    setup() {
      ...
      const p = re(c, e.inputId + '-ts-control'),
      ...
      (null === t.maxItems || t.maxItems > 1) && e.is_select_tag && G(a, { multiple: 'multiple' }),
        t.placeholder && G(i, { placeholder: t.placeholder }),
        ...
        ne(c, 'keydown', t => e.onKeyDown(t)),
        ne(i, 'keypress', t => e.onKeyPress(t)),
        ne(i, 'input', t => e.onInput(t)),
        ne(c, 'blur', t => e.onBlur(t)),
        ne(c, 'focus', t => e.onFocus(t)),
        ne(i, 'paste', t => e.onPaste(t));
      const v = t => {
      ...
      ne(document, 'mousedown', v),
        ne(window, 'scroll', m, d),
        ne(window, 'resize', m, d),
        (this._destroy = () => {
    ...
    sync(e = !0) {
      const t = this,
        i = e ? ce(t.input, { delimiter: t.settings.delimiter }) : t.settings;
    ...
    onMouseDown() {}
    onChange() {
      D(this.input, 'input'), D(this.input, 'change');
    }
    onPaste(e) {
      var t = this;
        ...
        : t.settings.splitOn &&
          setTimeout(() => {
            ...
            if (e.match(t.settings.splitOn)) {
              ...
              E(i, e => {
                Y(e) && (this.options[e] ? t.addItem(e) : t.createItem(e));
              });
            }
          }, 0);
    }
    ...
    onKeyDown(e) {
      ...
      if (((t.ignoreHover = !0), t.isLocked)) 9 !== e.keyCode && se(e);
        ...
        switch (e.keyCode) {
          case 65:
            if (oe(W, e) && '' == t.control_input.value) return se(e), void t.selectAll();
            break;
          case 27:
            return t.isOpen && (se(e, !0), t.close()), void t.clearActiveItems();
          case 40:
          ...
          case 13:
            return void (t.canSelect(t.activeOption)
              ? (t.onOptionSelect(e, t.activeOption), se(e))
              : ((t.settings.create && t.createItem()) || (document.activeElement == t.control_input && t.isOpen)) && se(e));
          case 37:
          ...
          case 9:
            return void (
              ...
              (t.canSelect(t.activeOption) && (t.onOptionSelect(e, t.activeOption), se(e)), t.settings.create && t.createItem() && se(e))
            );
          case 8:
          case 46:
    ...
    onFocus(e) {
      ...
      t.ignoreFocus ||
        ...
        i || t.trigger('focus'),
        t.activeItems.length || (t.showInput(), t.refreshOptions(!!t.settings.openOnFocus)),
        t.refreshState());
    }
    onBlur(e) {
    ...
    loadCallback(e, t) {
      ...
      (i.loading = Math.max(i.loading - 1, 0)),
        ...
        i.loading || z(i.wrapper, i.settings.loadingClass),
        i.trigger('load', e, t);
    }
    preload() {
    ...
    setActiveItem(e, t) {
      ...
      if ('single' !== a.settings.mode) {
        ...
        if ('click' === (i = t && t.type.toLowerCase()) && oe('shiftKey', t) && a.activeItems.length) {
          ...
          ('click' === i && oe(W, t)) || ('keydown' === i && oe('shiftKey', t))
    ...
    clearActiveItems() {
      z(this.activeItems, 'active'), (this.activeItems = []);
    }
    setActiveOption(e, t = !0) {
      e !== this.activeOption &&
        ...
        e &&
          ((this.activeOption = e),
          G(this.focus_node, { 'aria-activedescendant': e.getAttribute('id') }),
    ...
    clearActiveOption() {
      this.activeOption && (z(this.activeOption, 'active'), G(this.activeOption, { 'aria-selected': null })),
        (this.activeOption = null),
        G(this.focus_node, { 'aria-activedescendant': null });
    }
    selectAll() {
      const e = this;
    ...
    inputState() {
      ...
      e.control.contains(e.control_input) &&
        (G(e.control_input, { placeholder: e.settings.placeholder }),
        e.activeItems.length > 0 || (!e.isFocused && e.settings.hidePlaceholder && e.items.length > 0)
          ? (e.setTextboxValue(), (e.isInputHidden = !0))
          : (e.settings.hidePlaceholder && e.items.length > 0 && G(e.control_input, { placeholder: '' }), (e.isInputHidden = !1)),
    ...
    refreshOptions(e = !0) {
      ...
      for (
        ...
        for (
          ...
          let e = u[o];
          void 0 === e && ((e = document.createDocumentFragment()), p.push(o)),
            i > 0 &&
              ((d = d.cloneNode(!0)),
              G(d, { id: l.$id + '-clone-' + i, 'aria-selected': null }),
      ...
      h.settings.lockOptgroupOrder &&
        ...
        h.settings.highlight &&
          ((v = O.querySelectorAll('span.highlight')),
    ...
    removeItem(e = null, t) {
      ...
      (s = Q(e)),
        e.remove(),
        e.classList.contains('active') && ((n = i.activeItems.indexOf(e)), i.activeItems.splice(n, 1), z(e, 'active')),
        i.items.splice(s, 1),
        (i.lastQuery = null),
    ...
    updateOriginalInput(e = {}) {
      ...
      if (t.is_select_tag) {
        ...
        function o(i, s, o) {
          return (
            i || (i = V('<option value="' + ee(s) + '">' + ee(o) + '</option>')),
          ...
          0 == t.items.length && 'single' == t.settings.mode
            ...
            : t.items.forEach(n => {
                if (((i = t.options[n]), (s = i[t.settings.labelField] || ''), e.includes(i.$option))) {
                  o(t.input.querySelector(`option[value="${le(n)}"]:not(:checked)`), n, s);
    ...
    open() {
      ...
      e.isLocked ||
        ...
        ((e.isOpen = !0),
        G(e.focus_node, { 'aria-expanded': 'true' }),
        e.refreshState(),
        N(e.dropdown, { visibility: 'hidden', display: 'block' }),
        e.positionDropdown(),
        N(e.dropdown, { visibility: 'visible', display: 'block' }),
        e.focus(),
    ...
    close(e = !0) {
      ...
      e && (t.setTextboxValue(), 'single' === t.settings.mode && t.items.length && t.hideInput()),
        (t.isOpen = !1),
        G(t.focus_node, { 'aria-expanded': 'false' }),
        N(t.dropdown, { display: 'none' }),
    ...
    destroy() {
      ...
      e.trigger('destroy'),
        ...
        z(e.input, 'tomselected', 'ts-hidden-accessible'),
        e._destroy(),
      ...
      if (
        ...
        'option' === e || 'option_create' === e
          ? t[n.settings.disabledField]
            ? G(s, { 'aria-disabled': 'true' })
            : G(s, { 'data-selectable': '' })
          : 'optgroup' === e &&
            ((i = t.group[n.settings.optgroupValueField]),
            G(s, { 'data-group': i }),
            t.group[n.settings.disabledField] && G(s, { 'data-disabled': '' })),
        'option' === e || 'item' === e)
      ) {
        const i = Z(t[n.settings.valueField]);
        G(s, { 'data-value': i }),
          'item' === e
            ? (H(s, n.settings.itemClass), G(s, { 'data-ts-item': '' }))
            : (H(s, n.settings.optionClass), G(s, { role: 'option', id: t.$id }), (t.$div = s), (n.options[i] = t));
      }
      return s;
    }
    _render(e, t) {
  ...
  return (
      ...
      e.hook('after', 'setupTemplates', () => {
        ...
        e.hook('instead', 'onOptionSelect', (s, n) => {
          if (n.classList.contains('selected'))
            return n.classList.remove('selected'), e.removeItem(n.dataset.value), e.refreshOptions(), void se(s, !0);
          t.call(e, s, n), i(n);
        });
    }),
        ...
        e.hook('instead', 'lock', () => {
          ...
          e.on('initialize', () => {
            var t = $(e.control).sortable({
              ...
              disabled: e.isLocked,
              start: (e, i) => {
                i.placeholder.css('width', i.helper.css('width')), t.css({ overflow: 'visible' });
              },
              stop: () => {
      ...
      (e.settings.shouldOpen = !0),
        ...
        e.on('initialize', () => {
          e.control_input.addEventListener('keydown', t => {
            switch (t.keyCode) {
              case 27:
                return e.isOpen && (se(t, !0), e.close()), void e.clearActiveItems();
              case 9:
          ...
          e.hook('instead', 'onBlur', i => {
            ...
            ne(e.control_input, 'blur', () => e.onBlur()),
            e.hook('before', 'close', () => {
    ...
    ue.define('optgroup_columns', function () {
      ...
      e.hook('instead', 'onKeyDown', i => {
        ...
        (e.ignoreHover = !0),
          (r = B(e.activeOption, '[data-group]')),
          (s = Q(e.activeOption, '[data-selectable]')),
          r &&
        ...
        i.hook('after', 'setupTemplates', () => {
          ...
          i.settings.render.item = (t, n) => {
            ...
            return (
              ...
              ne(r, 'click', e => {
                se(e, !0), i.isLocked || (i.shouldDelete([o], e) && (i.removeItem(o), i.refreshOptions(!1), i.inputState()));
              }),
              o
            );
          };
      ...
      (e.setNextUrl = (e, t) => {
        ...
        e.hook('after', 'refreshOptions', () => {
          ...
          c(t)
            ...
            i && (H(i, e.settings.optionClass), n.append(i));
        }),
        e.on('initialize', () => {
