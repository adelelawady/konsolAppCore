...
export class BankResourceService {
  ...
  public createBank(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext }
  ): Observable<HttpResponse<BankDTO>>;
  public createBank(
    bankDTO: BankDTO,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext }
  ): Observable<HttpEvent<BankDTO>>;
  public createBank(
    bankDTO: BankDTO,
    observe: any = 'body',
    ...
    return this.httpClient.post<BankDTO>(`${this.configuration.basePath}/banks`, bankDTO, {
  ...
  public updateBank(
    ...
    return this.httpClient.patch<BankDTO>(`${this.configuration.basePath}/banks/${encodeURIComponent(String(id))}`, bankDTO, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: localVarHeaders,
