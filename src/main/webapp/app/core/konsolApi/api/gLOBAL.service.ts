...
export class GLOBALService {
  ...
  public getServerSettings(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext }
  ): Observable<HttpEvent<ServerSettings>>;
  public getServerSettings(
    observe: any = 'body',
    reportProgress: boolean = false,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext }
  ...
  public performBackup(
    ...
    return this.httpClient.post<boolean>(`${this.configuration.basePath}/sys/settings/backup`, null, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: localVarHeaders,
  ...
  public performRestore(
    performRestoreRequest: PerformRestoreRequest,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext }
  ): Observable<boolean>;
  ...
  public updateServerSettings(
    ...
    return this.httpClient.patch<ServerSettings>(`${this.configuration.basePath}/sys/settings`, serverSettings, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: localVarHeaders,
