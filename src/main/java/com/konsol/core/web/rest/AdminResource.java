...
import com.konsol.core.web.api.AdminApiDelegate;
 ...
 * <p>
 * This class accesses the {@link com.konsol.core.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
@Service
public class AdminResource implements AdminApiDelegate {
        ...
        if (userDTO.getId() != null) {
            ...
            try {
                return ResponseEntity
                    ...
                    .body(utilitsMapper.FromUserToAPIUser(newUser));
