...
import com.konsol.core.security.*;
import com.konsol.core.security.jwt.*;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/management/**").hasAnyAuthority(AuthoritiesConstants.ADMIN , AuthoritiesConstants.SUPER_ADMIN)
        .and()
            .httpBasic()
        .and()
