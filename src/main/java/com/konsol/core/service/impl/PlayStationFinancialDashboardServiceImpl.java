...
@Service
@Transactional
public class PlayStationFinancialDashboardServiceImpl implements PlaystationFinancialDashboardService {
    ...
    public FinancialChartDTO create(String chartId, String title, String chartType) {
        FinancialChartDTO chart = new FinancialChartDTO();
    ...
    public FinancialChartDTO create(String chartId, String title, String subtitle, String chartType, String xAxisLabel, String yAxisLabel) {
        FinancialChartDTO chart = new FinancialChartDTO();
        chart.setChartId(chartId);
        chart.setTitle(title);
