 ...
 * A Table.
 */
@Document(collection = "shopsTable")
public class ShopsTable implements Serializable {
    ...
    public ShopsTable id(String id) {
        this.setId(id);
        return this;
    }
    ...
    public ShopsTable name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public ShopsTable discount(Double discount) {
    ...
    public ShopsTable totalPrice(Double totalPrice) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShopsTable)) {
            return false;
        }
        return id != null && id.equals(((ShopsTable) o).id);
    }
